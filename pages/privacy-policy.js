...
<style dangerouslySetInnerHTML={{__html: `.policy-section{padding:80px 0 100px;background:var(--bg-primary,var(--bg-primary))}.policy-content{max-width:820px;margin:0 auto}.policy-date{display:inline-block;font-size:13px;font-weight:600;color:var(--accent);background:rgb(var(--accent-rgb) / .08);border:1px solid rgb(var(--accent-rgb) / .15);padding:8px 20px;border-radius:999px;margin-bottom:40px}.policy-content h2{font-size:24px;font-weight:800;color:var(--white);margin:48px 0 8px;letter-spacing:-.5px;padding-bottom:12px;border-bottom:1px solid rgb(var(--p-white-rgb) / .06)}.policy-content h2:first-of-type{margin-top:0}.policy-content h3{font-size:17px;font-weight:700;color:var(--text-primary);margin:24px 0 12px}.policy-content p{font-size:15px;color:var(--text-secondary);line-height:1.85;margin-bottom:16px}.policy-content ul{list-style:none;padding:0;margin:0 0 24px}.policy-content ul li{font-size:15px;color:var(--text-secondary);line-height:1.85;padding:10px 0 10px 28px;position:relative;border-bottom:1px solid rgb(var(--p-white-rgb) / .03)}.policy-content ul li:last-child{border-bottom:none}.policy-content ul li::before{content:"";position:absolute;left:0;top:18px;width:8px;height:8px;border-radius:2px;background:linear-gradient(135deg,var(--accent),var(--accent-light))}.policy-content strong{color:var(--text-primary)}.policy-intro{font-size:16px;color:#CBD5E1;line-height:1.9;background:rgb(var(--p-white-rgb) / .02);border:1px solid rgb(var(--p-white-rgb) / .06);border-radius:16px;padding:28px 32px;margin-bottom:40px;border-left:3px solid var(--accent)}.policy-note{font-size:14px;color:var(--text-secondary);font-style:italic;background:rgb(var(--accent-rgb) / .04);border:1px solid rgb(var(--accent-rgb) / .1);border-radius:12px;padding:20px 24px;margin-top:8px}.policy-section-num{display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:8px;background:rgb(var(--accent-rgb) / .1);color:var(--accent);font-size:13px;font-weight:800;margin-right:10px;flex-shrink:0}`}} />
      </Head>
