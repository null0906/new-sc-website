  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .sq-badge { display:inline-block; padding:.35rem .9rem; border-radius:var(--radius-full); background:rgba(255, 96, 0,.1); color:var(--accent-light); border:1px solid rgba(255, 96, 0,.25); font-size:.74rem; font-weight:700; margin-bottom:1rem; }
        ...
        .sq-tri.sel { background:rgba(255, 96, 0,.12); border-color:var(--accent); color:var(--white); font-weight:600; }
