  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .pr-badge { display:inline-block; padding:.35rem .9rem; border-radius:var(--radius-full); background:rgb(var(--accent-rgb) / .1); color:var(--accent-light); border:1px solid rgb(var(--accent-rgb) / .25); font-size:.74rem; font-weight:700; margin-bottom:1rem; }
        ...
        .pr-scope-inner { background:linear-gradient(135deg,rgb(var(--accent-rgb) / .1),rgb(var(--bg-card-rgb) / .6)); border:1px solid rgb(var(--accent-rgb) / .3); border-radius:var(--radius-lg); padding:2rem 2.25rem; display:flex; align-items:center; justify-content:space-between; gap:1.5rem; flex-wrap:wrap; }
        ...
        .pr-scope-btn:hover { background:rgb(var(--accent-rgb) / .1); }
