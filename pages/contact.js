...
<style dangerouslySetInnerHTML={{__html: `.contact-section{padding:80px 0;background:var(--bg-primary,#020617)}.contact-grid{display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:center;max-width:1000px;margin:0 auto}@media(max-width:768px){.contact-grid{grid-template-columns:1fr;gap:40px}}.contact-photo{width:320px;height:320px;border-radius:24px;overflow:hidden;border:3px solid rgba(255, 96, 0,.3);box-shadow:0 25px 60px rgba(0,0,0,.4),0 0 40px rgba(255, 96, 0,.08);margin:0 auto}.contact-photo img{width:100%;height:100%;object-fit:cover}.contact-info{}.contact-label{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#FF6000;margin-bottom:12px}.contact-name{font-size:clamp(32px,4vw,44px);font-weight:800;color:#F8FAFC;margin-bottom:4px;letter-spacing:-1px}.contact-role{font-size:20px;font-weight:600;color:#FF8A3D;margin-bottom:24px}.contact-bio{font-size:16px;color:#94A3B8;line-height:1.8;margin-bottom:32px}.contact-bg{background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:16px;padding:24px;margin-bottom:32px}.contact-bg h3{font-size:16px;font-weight:700;color:#F8FAFC;margin-bottom:16px}.contact-bg-list{list-style:none;padding:0;margin:0}.contact-bg-list li{font-size:14px;color:#94A3B8;line-height:1.8;padding-left:18px;position:relative;margin-bottom:8px}.contact-bg-list li::before{content:"\\25B8";position:absolute;left:0;color:#FF6000;font-weight:bold}.contact-buttons{display:flex;flex-wrap:wrap;gap:12px}.contact-btn{display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:12px;font-size:14px;font-weight:600;text-decoration:none;transition:all .3s ease}.contact-btn-primary{background:linear-gradient(135deg,#FF6000,#FF8A3D);color:white;box-shadow:0 4px 20px rgba(255, 96, 0,.3)}.contact-btn-primary:hover{transform:translateY(-2px);box-shadow:0 8px 30px rgba(255, 96, 0,.4)}.contact-btn-dark{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#E2E8F0}.contact-btn-dark:hover{background:rgba(255,255,255,.1);border-color:rgba(255,255,255,.2);transform:translateY(-2px)}.contact-btn-blue{background:rgba(59,130,246,.15);border:1px solid rgba(59,130,246,.25);color:#60A5FA}.contact-btn-blue:hover{background:rgba(59,130,246,.25);transform:translateY(-2px)}.contact-btn svg{width:18px;height:18px;fill:currentColor}.contact-touch-label{font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#64748B;margin-bottom:14px}`}} />
      </Head>
