...
export default function CISOCyberPioneers26() {
  ...
  return (
    <Layout>
      ...
      <style jsx global>{`
        :root{--cy:#E8632B;--cy2:#d0521f;--bg:#020617;--bgc:#0B1120;--bgc2:#0F172A;--tx:#fff;--tb:#c8d6e5;--tm:#6a8aaa;--bo:rgba(232,99,43,.2);--bs:rgba(255,255,255,.06);--gr:#06d6a0;--am:#ffb703;--bl:#818cf8;--sans:'Inter',sans-serif}
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        ...
        .ev-hero-img{border-radius:16px;overflow:hidden;border:1px solid var(--bo);line-height:0;box-shadow:0 20px 60px rgba(232,99,43,.12)}
        ...
        .cta-final{background:linear-gradient(135deg,rgba(232,99,43,.1),rgba(15,23,42,.95));border:1px solid var(--bo);border-radius:16px;padding:2.5rem 2rem;text-align:center;margin:3rem 0}
