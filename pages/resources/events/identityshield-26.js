  ...
  return (
    <Layout>
      ...
      <style jsx global>{`
        ...
        .mosaic-item:hover {
          border-color: var(--accent-border);
          box-shadow: 0 20px 50px rgba(0,0,0,0.5), 0 0 60px rgba(232,99,43,0.15);
          z-index: 5;
        }
        .mosaic-item img {
          width: 100%;
        ...
        .mosaic-item::after {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(135deg, transparent 40%, rgba(232,99,43,0.08) 100%);
          pointer-events: none;
          opacity: 0;
        ...
        .mosaic-item.mosaic-featured {
          border-color: var(--accent-border);
          box-shadow: 0 0 0 1px var(--accent-border), 0 0 40px rgba(232,99,43,0.1);
        }
