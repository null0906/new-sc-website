  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .scan-chip.on { background:rgba(232,99,43,.1); color:var(--accent-light); border-color:rgba(232,99,43,.3); }
        ...
        .scan-btn-outline { color:var(--accent); border:1px solid var(--accent-border,rgba(232,99,43,.3)); padding:.75rem 1.4rem; border-radius:10px; font-weight:600; text-decoration:none; font-size:.92rem; }
