...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .case-study{background:linear-gradient(135deg,rgb(var(--red-rgb) / .06),rgb(var(--bg-card-rgb) / .95));border:1px solid rgb(var(--red-rgb) / .25);border-radius:16px;padding:1.85rem 1.95rem;margin:2.25rem 0;position:relative;border-left:3px solid var(--rd)}
    .case-study-tag{display:inline-block;padding:.3rem .75rem;background:rgb(var(--red-rgb) / .12);color:var(--rd);border-radius:6px;font-size:.7rem;font-weight:800;letter-spacing:.06em;margin-bottom:.85rem;text-transform:uppercase}
