...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <rect x="510" y="35" width="420" height="230" rx="14" fill="#0d1c10" stroke="rgba(232,99,43,0.25)" strokeWidth="1.5"/>
          <rect x="510" y="35" width="420" height="3" rx="1.5" fill="#E8632B"/>
          <text x="720" y="62" textAnchor="middle" fill="#E8632B" fontSize="11" fontWeight="700" fontFamily="sans-serif">SIGNIFICANT DATA FIDUCIARY (SDF)</text>
