...
export default function EvaluateSecurityVendor() {
  ...
  return (
    <Layout>
      ...
      <style jsx global>{`
        :root{--cy:#FF6000;--cy2:#d0521f;--glow:rgba(255, 96, 0,.12);--bg:#020617;--bgc:#0B1120;--bgc2:#0F172A;--tx:#F8FAFC;--tb:#E2E8F0;--tm:#94A3B8;--bo:rgba(255, 96, 0,.2);--bs:rgba(255,255,255,.06);--gr:#10B981;--rd:#EF4444;--am:#F59E0B;--sans:'Inter',sans-serif;--mono:'JetBrains Mono',monospace}
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .question-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#FF6000,#FF8A3D)}
        .question-num{position:absolute;top:22px;right:24px;font-size:2.5rem;font-weight:900;color:rgba(255, 96, 0,.08);line-height:1}
