...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .question-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--accent),var(--accent-light))}
        .question-num{position:absolute;top:22px;right:24px;font-size:2.5rem;font-weight:900;color:rgb(var(--accent-rgb) / .08);line-height:1}
        ...
        .redflag-card{background:rgb(var(--red-rgb) / .04);border:1px solid rgb(var(--red-rgb) / .18);border-left:3px solid var(--red);border-radius:0 12px 12px 0;padding:20px 24px;margin:2em 0}
        .redflag-card strong{color:var(--red);font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:12px}
        ...
        .pro-tip{background:rgb(var(--yellow-rgb) / .05);border:1px solid rgb(var(--yellow-rgb) / .2);border-left:3px solid var(--yellow);border-radius:0 12px 12px 0;padding:16px 22px;margin:2em 0}
        .pro-tip strong{color:var(--yellow);font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:8px}
        ...
        .yes-badge{display:inline-block;padding:2px 9px;background:rgb(var(--green-rgb) / .12);border:1px solid rgb(var(--green-rgb) / .25);border-radius:100px;font-size:.72rem;font-weight:700;color:var(--green-light)}
        .no-badge{display:inline-block;padding:2px 9px;background:rgb(var(--red-rgb) / .1);border:1px solid rgb(var(--red-rgb) / .22);border-radius:100px;font-size:.72rem;font-weight:700;color:#FCA5A5}
        .ok-badge{display:inline-block;padding:2px 9px;background:rgb(var(--yellow-rgb) / .1);border:1px solid rgb(var(--yellow-rgb) / .22);border-radius:100px;font-size:.72rem;font-weight:700;color:#FCD34D}
        ...
        .score-icon{width:30px;height:30px;border-radius:8px;background:rgb(var(--green-rgb) / .1);border:1px solid rgb(var(--green-rgb) / .25);display:flex;align-items:center;justify-content:center;font-size:.9rem;flex-shrink:0;margin-top:1px}
        ...
        .contract-warn{background:rgb(var(--red-rgb) / .04);border:1px solid rgb(var(--red-rgb) / .15);border-radius:12px;padding:20px 22px;margin:2em 0}
        .contract-warn strong{color:var(--red);font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:10px}
        .contract-warn p{font-size:.9rem;color:var(--tb);line-height:1.7;margin-bottom:.7em}
        .contract-warn p:last-child{margin-bottom:0}
        .non-neg{background:rgb(var(--green-rgb) / .05);border:1px solid rgb(var(--green-rgb) / .18);border-radius:12px;padding:16px 20px;margin:1.5em 0}
        .non-neg strong{color:var(--green-light);font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:8px}
