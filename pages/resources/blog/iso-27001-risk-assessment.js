...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          {[{n:"01",t:"IDENTIFY",sub:"Assets, threats, vulnerabilities",col:"#818cf8",x:50},{n:"02",t:"ASSESS",sub:"Likelihood × Impact = Risk Score",col:"#0081f2",x:280},{n:"03",t:"TREAT",sub:"Mitigate, accept, transfer, avoid",col:"#06d6a0",x:520},{n:"04",t:"MONITOR",sub:"Review, update, improve",col:"#ffb703",x:750}].map(({n,t,sub,col,x},i) => (
            <g key={i}>
