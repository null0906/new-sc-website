...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs5" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          {[{n:"01",t:"IDENTIFY",sub:"Assets, threats, vulnerabilities",col:"#818cf8",x:50},{n:"02",t:"ASSESS",sub:"Likelihood × Impact = Risk Score",col:"#FF6000",x:280},{n:"03",t:"TREAT",sub:"Mitigate, accept, transfer, avoid",col:"#06d6a0",x:520},{n:"04",t:"MONITOR",sub:"Review, update, improve",col:"#ffb703",x:750}].map(({n,t,sub,col,x},i) => (
            <g key={i}>
