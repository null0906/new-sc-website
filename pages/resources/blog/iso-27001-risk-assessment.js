...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          {[{n:"01",t:"IDENTIFY",sub:"Assets, threats, vulnerabilities",col:"var(--purple)",x:50},{n:"02",t:"ASSESS",sub:"Likelihood × Impact = Risk Score",col:"var(--accent)",x:280},{n:"03",t:"TREAT",sub:"Mitigate, accept, transfer, avoid",col:"var(--green)",x:520},{n:"04",t:"MONITOR",sub:"Review, update, improve",col:"var(--yellow)",x:750}].map(({n,t,sub,col,x},i) => (
            <g key={i}>
              <rect x={x} y="40" width="195" height="150" rx="14" fill="var(--bg-secondary)" stroke={col+"25"} strokeWidth="1.5"/>
