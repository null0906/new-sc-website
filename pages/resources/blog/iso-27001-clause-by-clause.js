      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 280" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs><pattern id="pgs7" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
            ...
            {[
              {n:"4",t:"Context",sub:"Org & scope",col:"var(--accent)",x:30},
              {n:"5",t:"Leadership",sub:"Top-mgmt commitment",col:"var(--green)",x:165},
              {n:"6",t:"Planning",sub:"Risk & objectives",col:"var(--purple)",x:300},
              {n:"7",t:"Support",sub:"Resources & docs",col:"var(--yellow)",x:435},
              {n:"8",t:"Operation",sub:"Run the ISMS",col:"#22d3ee",x:570},
              {n:"9",t:"Eval",sub:"Audit & review",col:"var(--red)",x:705},
