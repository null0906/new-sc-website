...
export default function TabletopSecurityExercise() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .role-table tr:hover td{background:rgba(0, 129, 242,.03)}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="tpat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            ...
            <rect x="16" y="52" width="220" height="352" rx="12" fill="#081826" stroke="rgba(0, 129, 242,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {time:'T+0:00',    label:'Scenario intro (15 min)',   col:'#0081f2', done:false},
              {time:'T+0:15',    label:'Inject 1: Initial alert',   col:'#0081f2', done:false},
              {time:'T+0:45',    label:'Inject 2: Escalation',      col:'#0081f2', done:false},
            ...
            <line x1="250" y1="48" x2="250" y2="404" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {gap:'Executive escalation path unclear',   owner:'CEO Ofc', priority:'Medium',   col:'#0081f2'},
            ...
            <text x="730" y="192" textAnchor="middle" fill="rgba(0, 129, 242,0.7)" fontSize="9" fontFamily="sans-serif">Pre-Exercise</text>
