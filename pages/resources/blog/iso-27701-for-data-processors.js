...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap"><svg viewBox="0 0 960 260" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
          <defs><pattern id="pgp1" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          {[{c:"9.1",t:"Processing Conditions",sub:"DPAs, purpose limitation, no marketing use",col:"var(--accent)",x:30},{c:"9.2",t:"Data Subject Support",sub:"Notify controllers of DSR requests",col:"var(--purple)",x:222},{c:"9.3",t:"Privacy by Design",sub:"Build privacy into products and services",col:"var(--green)",x:414},{c:"9.4",t:"Breach Notification",sub:"Notify controller within 24-72 hours",col:"var(--red)",x:606},{c:"9.5",t:"Sub-Processor Mgmt",sub:"Authorisation, contracts, due diligence",col:"var(--yellow)",x:798}].map(({c,t,sub,col,x},i) => (
            <g key={i}>
              <rect x={x} y="38" width="150" height="180" rx="12" fill="var(--bg-secondary)" stroke={col+"22"} strokeWidth="1.5"/>
