...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg6" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="222" height="230" rx="14" fill="var(--bg-secondary)" stroke="rgba(106,138,170,0.2)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="222" height="4" rx="2" fill="var(--text-secondary)"/>
          ...
          <rect x="262" y="38" width="222" height="230" rx="14" fill="#071820" stroke="rgb(var(--green-rgb) / 0.25)" strokeWidth="1.5"/>
          <rect x="262" y="38" width="222" height="4" rx="2" fill="var(--green)"/>
          <text x="373" y="70" textAnchor="middle" fill="var(--green)" fontSize="10" fontWeight="800" fontFamily="sans-serif">TIER 2</text>
          ...
          <text x="373" y="180" textAnchor="middle" fill="var(--green)" fontSize="9" fontWeight="700" fontFamily="sans-serif">ACTION</text>
          ...
          <rect x="494" y="38" width="222" height="230" rx="14" fill="#141108" stroke="rgb(var(--yellow-rgb) / 0.3)" strokeWidth="1.5"/>
          <rect x="494" y="38" width="222" height="4" rx="2" fill="var(--yellow)"/>
          <text x="605" y="70" textAnchor="middle" fill="var(--yellow)" fontSize="10" fontWeight="800" fontFamily="sans-serif">TIER 3</text>
          ...
          <text x="605" y="180" textAnchor="middle" fill="var(--yellow)" fontSize="9" fontWeight="700" fontFamily="sans-serif">ACTION</text>
          ...
          <rect x="726" y="38" width="222" height="230" rx="14" fill="#180a0d" stroke="rgb(var(--red-rgb) / 0.3)" strokeWidth="1.5"/>
          <rect x="726" y="38" width="222" height="4" rx="2" fill="var(--red)"/>
          <text x="837" y="70" textAnchor="middle" fill="var(--red)" fontSize="10" fontWeight="800" fontFamily="sans-serif">TIER 4</text>
          ...
          <text x="837" y="180" textAnchor="middle" fill="var(--red)" fontSize="9" fontWeight="700" fontFamily="sans-serif">ACTION</text>
