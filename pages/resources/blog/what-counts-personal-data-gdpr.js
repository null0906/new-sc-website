...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgh" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="580" height="210" rx="14" fill="#071820" stroke="rgb(var(--green-rgb) / 0.25)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="580" height="4" rx="2" fill="var(--green)"/>
          <text x="320" y="65" textAnchor="middle" fill="var(--green)" fontSize="11" fontWeight="800" fontFamily="sans-serif">YES - THIS IS PERSONAL DATA UNDER GDPR</text>
          ...
          <rect x="640" y="38" width="290" height="210" rx="14" fill="#180a0d" stroke="rgb(var(--red-rgb) / 0.25)" strokeWidth="1.5"/>
          <rect x="640" y="38" width="290" height="4" rx="2" fill="var(--red)"/>
          <text x="785" y="65" textAnchor="middle" fill="var(--red)" fontSize="11" fontWeight="800" fontFamily="sans-serif">NOT PERSONAL DATA</text>
