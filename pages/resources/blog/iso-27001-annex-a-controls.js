...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs4" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          {[{t:"ORGANISATIONAL",n:"37",sub:"Policies, governance, vendor mgmt",col:"var(--accent)",x:50,pct:"40%"},{t:"PEOPLE",n:"8",sub:"HR, training, awareness",col:"var(--purple)",x:280,pct:"9%"},{t:"PHYSICAL",n:"14",sub:"Facilities, equipment, media",col:"var(--green)",x:520,pct:"15%"},{t:"TECHNOLOGICAL",n:"34",sub:"Access, crypto, network, app security",col:"var(--yellow)",x:750,pct:"37%"}].map(({t,n,sub,col,x,pct},i) => (
            <g key={i}>
              <rect x={x} y="40" width="195" height="200" rx="14" fill="var(--bg-secondary)" stroke={col+"25"} strokeWidth="1.5"/>
