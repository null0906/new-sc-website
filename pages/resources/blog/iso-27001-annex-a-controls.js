...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs4" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          {[{t:"ORGANISATIONAL",n:"37",sub:"Policies, governance, vendor mgmt",col:"#0081f2",x:50,pct:"40%"},{t:"PEOPLE",n:"8",sub:"HR, training, awareness",col:"#818cf8",x:280,pct:"9%"},{t:"PHYSICAL",n:"14",sub:"Facilities, equipment, media",col:"#06d6a0",x:520,pct:"15%"},{t:"TECHNOLOGICAL",n:"34",sub:"Access, crypto, network, app security",col:"#ffb703",x:750,pct:"37%"}].map(({t,n,sub,col,x,pct},i) => (
            <g key={i}>
