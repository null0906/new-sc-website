...
export default function ISO27001InternalAudit() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .nc-card.r-maj .nc-tag{background:rgba(255,77,109,0.12);color:var(--rd)}
    .nc-card.r-min .nc-tag{background:rgba(255,183,3,0.12);color:var(--am)}
    .nc-card.r-ofi .nc-tag{background:rgba(129,140,248,0.12);color:var(--bl)}
    .nc-card.r-ok .nc-tag{background:rgba(6,214,160,0.12);color:var(--gr)}
