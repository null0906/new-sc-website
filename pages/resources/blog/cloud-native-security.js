...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .four-c-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--accent),var(--accent-light))}
        ...
        .insight-box{background:rgb(var(--purple-rgb) / .05);border:1px solid rgb(var(--purple-rgb) / .18);border-left:3px solid var(--purple);border-radius:0 12px 12px 0;padding:16px 22px;margin:2em 0}
        .insight-box strong{color:var(--purple);font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:8px}
        .insight-box p{font-size:.9rem;color:var(--tb);line-height:1.65;margin:0}
        .compliance-note{background:rgb(var(--accent-rgb) / .05);border:1px solid rgb(var(--accent-rgb) / .18);border-left:3px solid var(--cy);border-radius:0 12px 12px 0;padding:16px 22px;margin:2em 0}
        ...
        .author-bio .bio-avatar{width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,var(--accent),var(--accent-light));display:flex;align-items:center;justify-content:center;font-weight:800;font-size:1.1rem;color:#fff;flex-shrink:0;box-shadow:0 4px 16px rgb(var(--accent-rgb) / .3)}
