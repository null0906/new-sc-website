...
export default function CloudNativeSecurity() {
  ...
  return (
    <Layout>
      ...
      <style jsx global>{`
        :root{--cy:#FF6000;--cy2:#d0521f;--bg:#020617;--bgc:#0B1120;--bgc2:#0F172A;--tx:#F8FAFC;--tb:#E2E8F0;--tm:#94A3B8;--bo:rgba(255, 96, 0,.2);--bs:rgba(255,255,255,.06);--gr:#10B981;--am:#F59E0B;--bl:#FF8A3D;--sans:'Inter',sans-serif;--mono:'JetBrains Mono',monospace}
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .four-c-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#FF6000,#FF8A3D)}
        ...
        .concept-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#FF6000,#FF8A3D)}
        ...
        .def-box{background:rgba(56,189,248,.05);border:1px solid rgba(56,189,248,.15);border-left:3px solid #FF8A3D;border-radius:0 12px 12px 0;padding:18px 22px;margin:2em 0}
        .def-box strong{color:#FF8A3D;font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:10px}
        ...
        .compliance-note{background:rgba(255, 96, 0,.05);border:1px solid rgba(255, 96, 0,.18);border-left:3px solid var(--cy);border-radius:0 12px 12px 0;padding:16px 22px;margin:2em 0}
        ...
        .author-bio .bio-avatar{width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#FF6000,#FF8A3D);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:1.1rem;color:#fff;flex-shrink:0;box-shadow:0 4px 16px rgba(255, 96, 0,.3)}
        ...
        code{background:#1E293B;color:#FF8A3D;padding:2px 7px;border-radius:5px;font-size:.88rem;font-family:var(--mono)}
