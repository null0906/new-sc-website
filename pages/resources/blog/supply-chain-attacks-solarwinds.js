...
export default function SupplyChainAttacks() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .timeline-wrap::before{content:'';position:absolute;left:7px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,#FF6000,rgba(255, 96, 0,0.1))}
    ...
    @media(max-width:600px){.cspm-hero-h1{font-size:1.65rem}.toc-grid{grid-template-columns:1fr}}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 400" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="scg1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#FF6000"/><stop offset="100%" stopColor="#FF8A3D"/></linearGradient>
              ...
              <pattern id="scpat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern>
            </defs>
            ...
            {[
              ...
              {phase:'Delivery',          detail:'Malicious update signed, pushed to 18,000 orgs', col:'#FF6000'},
              {phase:'C2 Activation',     detail:'2-week dormancy, then beacon to avsvmcloud.com', col:'#FF6000'},
            ...
            <line x1="438" y1="46" x2="438" y2="388" stroke="rgba(255, 96, 0,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {label:'US Federal agencies hit',    val:'9',         col:'#FF6000'},
              {label:'Fortune 500 victims',        val:'425+',      col:'#FF6000'},
            ...
            <line x1="740" y1="46" x2="740" y2="388" stroke="rgba(255, 96, 0,0.07)" strokeWidth="1"/>
      ...
      <div className="blog-layout">
        <article className="art">
          ...
          <p style={{fontSize:'1.05rem',lineHeight:'1.85',color:'var(--tb)',marginBottom:'1.5rem',borderLeft:'3px solid rgba(255, 96, 0,0.3)',paddingLeft:'1.2rem'}}>For decades, the software security model was built on a simple premise: verify the vendor, verify the certificate, trust the update. SolarWinds shattered that model in a way that is still reshaping how organisations think about trust. This article breaks down exactly how the attack worked, why it succeeded despite the victims having mature security programmes, and the specific controls that every organisation must now have in place - informed by the single most instructive supply chain attack in cybersecurity history.</p>
