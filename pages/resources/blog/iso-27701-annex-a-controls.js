...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap"><svg viewBox="0 0 960 260" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
          <defs><pattern id="pgp2" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="440" height="190" rx="14" fill="#091826" stroke="#FF600022" strokeWidth="1.5"/>
          <rect x="30" y="38" width="440" height="4" rx="2" fill="#FF6000"/>
          <text x="250" y="65" textAnchor="middle" fill="#FF6000" fontSize="12" fontWeight="800" fontFamily="sans-serif">ANNEX A - CONTROLLER CONTROLS</text>
