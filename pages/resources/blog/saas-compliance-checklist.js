...
export default function SaaSComplianceChecklist() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .chk-section-num{width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#E8632B,#FF8A50);display:flex;align-items:center;justify-content:center;font-size:.72rem;font-weight:700;color:#fff;flex-shrink:0}
    ...
    .chk-box{width:16px;height:16px;border-radius:3px;border:1.5px solid rgba(232,99,43,.35);background:rgba(232,99,43,.05);flex-shrink:0;margin-top:2px}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="sc" width="24" height="24" patternUnits="userSpaceOnUse"><circle cx="12" cy="12" r=".8" fill="rgba(232,99,43,0.04)"/></pattern>
            </defs>
            <rect width="960" height="420" fill="url(#sc)"/>
            {/* Left: Framework selector */}
            <rect x="18" y="18" width="210" height="384" rx="12" fill="#081826" stroke="rgba(232,99,43,0.15)" strokeWidth="1"/>
            ...
            <line x1="242" y1="14" x2="242" y2="406" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            <circle cx="480" cy="200" r="55" fill="rgba(232,99,43,0.06)" stroke="rgba(232,99,43,0.2)" strokeWidth="1.5"/>
            <text x="480" y="195" textAnchor="middle" fill="#E8632B" fontSize="22" fontWeight="800" fontFamily="sans-serif">9</text>
            ...
            <line x1="648" y1="14" x2="648" y2="406" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {phase:'Month 3–4', title:'Technical Layer', items:'Vuln Mgmt · Encryption · Logging infra', col:'#E8632B'},
