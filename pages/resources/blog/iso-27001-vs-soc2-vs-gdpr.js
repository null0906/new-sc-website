...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs1" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          {[{t:"ISO 27001",sub:"International Standard",nature:"Certification",geo:"Global (160+ countries)",col:"#0081f2",x:30},{t:"SOC 2",sub:"AICPA Framework",nature:"Attestation Report",geo:"Primarily US market",col:"#818cf8",x:340},{t:"GDPR",sub:"EU Regulation",nature:"Legal Requirement",geo:"EU/EEA data subjects",col:"#06d6a0",x:650}].map(({t,sub,nature,geo,col,x},i) => (
            <g key={i}>
