...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs1" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          {[{t:"ISO 27001",sub:"International Standard",nature:"Certification",geo:"Global (160+ countries)",col:"var(--accent)",x:30},{t:"SOC 2",sub:"AICPA Framework",nature:"Attestation Report",geo:"Primarily US market",col:"var(--purple)",x:340},{t:"GDPR",sub:"EU Regulation",nature:"Legal Requirement",geo:"EU/EEA data subjects",col:"var(--green)",x:650}].map(({t,sub,nature,geo,col,x},i) => (
            <g key={i}>
              <rect x={x} y="38" width="275" height="210" rx="14" fill="var(--bg-secondary)" stroke={col+"25"} strokeWidth="1.5"/>
