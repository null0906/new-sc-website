...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs2" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          {[{t:"PLAN",sub:"Risk assessment, scope, objectives",col:"#818cf8",x:50},{t:"DO",sub:"Implement controls, policies, training",col:"#0081f2",x:280},{t:"CHECK",sub:"Internal audit, monitoring, review",col:"#06d6a0",x:520},{t:"ACT",sub:"Correct, improve, iterate",col:"#ffb703",x:750}].map(({t,sub,col,x},i) => (
            <g key={i}>
