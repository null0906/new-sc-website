...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <rect x="50" y="180" width="250" height="24" rx="6" fill="rgba(232,99,43,0.07)" stroke="rgba(232,99,43,0.2)" strokeWidth="1"/>
          <text x="175" y="196" textAnchor="middle" fill="#E8632B" fontSize="9" fontWeight="700" fontFamily="sans-serif">HOW to build and run a privacy programme</text>
