...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pga" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="290" height="230" rx="14" fill="#091826" stroke="#FF600028" strokeWidth="1.5"/>
          <rect x="30" y="38" width="290" height="4" rx="2" fill="#FF6000"/>
          <text x="175" y="68" textAnchor="middle" fill="#FF6000" fontSize="13" fontWeight="800" fontFamily="sans-serif">ISO 27701</text>
          ...
          <rect x="50" y="180" width="250" height="24" rx="6" fill="rgba(255, 96, 0,0.07)" stroke="rgba(255, 96, 0,0.2)" strokeWidth="1"/>
          <text x="175" y="196" textAnchor="middle" fill="#FF6000" fontSize="9" fontWeight="700" fontFamily="sans-serif">HOW to build and run a privacy programme</text>
