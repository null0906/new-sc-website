...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pga" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="290" height="230" rx="14" fill="var(--bg-secondary)" stroke="rgb(var(--accent-rgb) / 0.157)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="290" height="4" rx="2" fill="var(--accent)"/>
          <text x="175" y="68" textAnchor="middle" fill="var(--accent)" fontSize="13" fontWeight="800" fontFamily="sans-serif">ISO 27701</text>
          ...
          <rect x="50" y="180" width="250" height="24" rx="6" fill="rgb(var(--accent-rgb) / 0.07)" stroke="rgb(var(--accent-rgb) / 0.2)" strokeWidth="1"/>
          <text x="175" y="196" textAnchor="middle" fill="var(--accent)" fontSize="9" fontWeight="700" fontFamily="sans-serif">HOW to build and run a privacy programme</text>
          ...
          <rect x="335" y="38" width="290" height="230" rx="14" fill="var(--bg-secondary)" stroke="#06d6a028" strokeWidth="1.5"/>
          <rect x="335" y="38" width="290" height="4" rx="2" fill="var(--green)"/>
          <text x="480" y="68" textAnchor="middle" fill="var(--green)" fontSize="13" fontWeight="800" fontFamily="sans-serif">GDPR</text>
          ...
          <rect x="355" y="180" width="250" height="24" rx="6" fill="rgb(var(--green-rgb) / 0.06)" stroke="rgb(var(--green-rgb) / 0.2)" strokeWidth="1"/>
          <text x="480" y="196" textAnchor="middle" fill="var(--green)" fontSize="9" fontWeight="700" fontFamily="sans-serif">WHAT rights individuals have under EU law</text>
          ...
          <rect x="640" y="38" width="290" height="230" rx="14" fill="var(--bg-secondary)" stroke="#ffb70328" strokeWidth="1.5"/>
          <rect x="640" y="38" width="290" height="4" rx="2" fill="var(--yellow)"/>
          <text x="785" y="68" textAnchor="middle" fill="var(--yellow)" fontSize="13" fontWeight="800" fontFamily="sans-serif">INDIA DPDP ACT</text>
          ...
          <rect x="660" y="180" width="250" height="24" rx="6" fill="rgb(var(--yellow-rgb) / 0.06)" stroke="rgb(var(--yellow-rgb) / 0.2)" strokeWidth="1"/>
          <text x="785" y="196" textAnchor="middle" fill="var(--yellow)" fontSize="9" fontWeight="700" fontFamily="sans-serif">WHAT obligations apply under Indian law</text>
