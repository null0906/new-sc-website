...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .rating-card.r-c .rating-tag{background:rgb(var(--green-rgb) / 0.12);color:var(--gr)}
    .rating-card.r-p .rating-tag{background:rgb(var(--yellow-rgb) / 0.12);color:var(--am)}
    .rating-card.r-m .rating-tag{background:rgb(var(--red-rgb) / 0.12);color:var(--rd)}
    .rating-card.r-na .rating-tag{background:rgb(var(--purple-rgb) / 0.12);color:var(--bl)}
