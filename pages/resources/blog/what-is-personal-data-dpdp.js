...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg8" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="450" height="240" rx="14" fill="#071820" stroke="rgb(var(--green-rgb) / 0.25)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="450" height="3" rx="1.5" fill="var(--green)"/>
          <text x="255" y="65" textAnchor="middle" fill="var(--green)" fontSize="11" fontWeight="800" fontFamily="sans-serif">✓ IN SCOPE - PERSONAL DATA</text>
          
          <text x="55" y="90" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Identity:</text>
          <text x="120" y="90" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Name, DOB, Aadhaar, PAN, Passport</text>
          <text x="55" y="110" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Contact:</text>
          <text x="120" y="110" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Email, phone, address, IP address</text>
          <text x="55" y="130" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Financial:</text>
          <text x="120" y="130" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Bank details, card numbers, UPI IDs</text>
          <text x="55" y="150" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Health:</text>
          <text x="120" y="150" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Medical records, prescriptions, fitness</text>
          <text x="55" y="170" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Biometric:</text>
          <text x="120" y="170" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Fingerprints, facial data, iris scans</text>
          <text x="55" y="190" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Behavioural:</text>
          <text x="130" y="190" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Browsing history, purchase patterns</text>
          <text x="55" y="210" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Location:</text>
          <text x="120" y="210" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">GPS coordinates, location history</text>
          <text x="55" y="230" fill="var(--green)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Employment:</text>
          <text x="135" y="230" fill="rgba(200,214,229,0.6)" fontSize="9.5" fontFamily="sans-serif">Salary, performance, leave records</text>
          <rect x="50" y="248" width="410" height="22" rx="6" fill="rgb(var(--green-rgb) / 0.06)" stroke="rgb(var(--green-rgb) / 0.2)" strokeWidth="1"/>
          <text x="255" y="262" textAnchor="middle" fill="var(--green)" fontSize="9" fontWeight="700" fontFamily="sans-serif">Everything above = compliance obligations apply</text>
          <rect x="510" y="38" width="420" height="240" rx="14" fill="#180a0d" stroke="rgb(var(--red-rgb) / 0.3)" strokeWidth="1.5"/>
          <rect x="510" y="38" width="420" height="3" rx="1.5" fill="var(--red)"/>
          <text x="720" y="65" textAnchor="middle" fill="var(--red)" fontSize="11" fontWeight="800" fontFamily="sans-serif">✗ OUT OF SCOPE</text>
          <text x="535" y="100" fill="var(--red)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Anonymised:</text>
          ...
          <text x="535" y="145" fill="var(--red)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Company Data:</text>
          ...
          <text x="535" y="190" fill="var(--red)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">Aggregate Stats:</text>
          ...
          <rect x="530" y="235" width="380" height="32" rx="8" fill="rgb(var(--red-rgb) / 0.07)" stroke="rgb(var(--red-rgb) / 0.2)" strokeWidth="1"/>
          <text x="720" y="249" textAnchor="middle" fill="var(--red)" fontSize="9" fontWeight="700" fontFamily="sans-serif">Only truly irreversible anonymisation qualifies</text>
