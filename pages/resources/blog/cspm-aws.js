...
export default function CSPMForAWS() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .sev-med{background:rgba(255, 96, 0,.15);color:#FF6000}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="g1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#FF6000"/><stop offset="100%" stopColor="#FF8A3D"/></linearGradient>
              ...
              <pattern id="dots" width="24" height="24" patternUnits="userSpaceOnUse"><circle cx="12" cy="12" r=".8" fill="rgba(255, 96, 0,0.04)"/></pattern>
            </defs>
            <rect width="960" height="420" fill="url(#dots)"/>

            {/* LEFT: AWS Service coverage */}
            <rect x="16" y="16" width="220" height="388" rx="12" fill="#081826" stroke="rgba(255, 96, 0,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {svc:'RDS Instances',      findings:3,  col:'#FF6000', pct:44},
            ...
            <line x1="250" y1="12" x2="250" y2="408" stroke="rgba(255, 96, 0,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {label:'Medium',   count:'11', col:'#FF6000', x:510},
            ...
            <line x1="718" y1="12" x2="718" y2="408" stroke="rgba(255, 96, 0,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {title:'IAM access key >90 days old',   sev:'MEDIUM',   c:'#FF6000'},
            ].map(({title,sev,c},i)=>(
              <g key={i}>
