...
export default function DPDPActIndianBusinesses() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .pen-table tr:hover td{background:rgba(0, 129, 242,.03)}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="dp" width="24" height="24" patternUnits="userSpaceOnUse"><circle cx="12" cy="12" r=".8" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            <rect width="960" height="420" fill="url(#dp)"/>
            {/* Left: Timeline */}
            <rect x="18" y="18" width="218" height="384" rx="12" fill="#081826" stroke="rgba(0, 129, 242,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {date:'NOW →',     event:'Compliance build window',       col:'#0081f2', done:false},
              ...
              <g key={i}>
                ...
                <circle cx="56" cy={74+i*68} r="10" fill={done?"rgba(6,214,160,0.15)":i===2?"rgba(0, 129, 242,0.15)":"rgba(255,255,255,0.05)"} stroke={col} strokeWidth="1.5"/>
