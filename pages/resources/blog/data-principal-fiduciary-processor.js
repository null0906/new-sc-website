...
export default function DataPrincipalFiduciaryProcessor() {
  ...
  const css = `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .rc-p::before{background:#818cf8}.rc-f::before{background:#E8632B}.rc-pr::before{background:#06d6a0}
    .rc-label{font-size:.65rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem}
    .rc-p .rc-label{color:#818cf8}.rc-f .rc-label{color:#E8632B}.rc-pr .rc-label{color:#06d6a0}
    ...
    .step-num{width:28px;height:28px;border-radius:8px;background:rgba(232,99,43,.15);color:var(--cy);font-size:.8rem;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:2px}
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 320" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            ...
            <rect x="340" y="40" width="280" height="240" rx="12" fill="#0d1c10" stroke="#E8632B28" strokeWidth="1.5"/>
            <rect x="340" y="40" width="280" height="3" rx="1.5" fill="#E8632B"/>
            <text x="480" y="70" textAnchor="middle" fill="#E8632B" fontSize="10" fontWeight="800" fontFamily="sans-serif">DATA FIDUCIARY · Section 2(i)</text>
