...
export default function DataPrincipalFiduciaryProcessor() {
  ...
  const css = `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .rc-p::before{background:#818cf8}.rc-f::before{background:#0081f2}.rc-pr::before{background:#06d6a0}
    .rc-label{font-size:.65rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem}
    .rc-p .rc-label{color:#818cf8}.rc-f .rc-label{color:#0081f2}.rc-pr .rc-label{color:#06d6a0}
    ...
    .step-num{width:28px;height:28px;border-radius:8px;background:rgba(0, 129, 242,.15);color:var(--cy);font-size:.8rem;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:2px}
    ...
    <Layout>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 320" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs><pattern id="pg1" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
            ...
            <rect x="340" y="40" width="280" height="240" rx="12" fill="#0d1c10" stroke="#0081f228" strokeWidth="1.5"/>
            <rect x="340" y="40" width="280" height="3" rx="1.5" fill="#0081f2"/>
            <text x="480" y="70" textAnchor="middle" fill="#0081f2" fontSize="10" fontWeight="800" fontFamily="sans-serif">DATA FIDUCIARY · Section 2(i)</text>
            ...
            {['Consent management','Purpose limitation','Data minimisation','Breach notification','Grievance mechanism'].map((t,i)=>(<g key={i}><circle cx="368" cy={118+i*24} r="3" fill="#0081f2" opacity="0.6"/><text x="380" y={122+i*24} fill="rgba(200,214,229,0.55)" fontSize="10" fontFamily="sans-serif">{t}</text></g>))}
            <rect x="360" y="245" width="240" height="22" rx="6" fill="rgba(0, 129, 242,0.07)" stroke="rgba(0, 129, 242,0.2)" strokeWidth="1"/>
            <text x="480" y="260" textAnchor="middle" fill="#0081f2" fontSize="8.5" fontWeight="700" fontFamily="sans-serif">Primary accountability - duty of care</text>
      ...
      <div className="blog-layout">
        <article className="art">
          ...
          <p style={{fontSize:'1.05rem',lineHeight:'1.85',color:'var(--tb)',marginBottom:'1.5rem',borderLeft:'3px solid rgba(0, 129, 242,0.3)',paddingLeft:'1.2rem'}}>India's DPDP Act introduces a clear cast of characters - each with distinct rights, obligations, and accountability. Before your organisation can think about compliance, you need to know <strong>who you are in the data ecosystem</strong>. Confusing these roles is not a semantic error - it creates real compliance blind spots in your consent architecture and vendor contracts.</p>
