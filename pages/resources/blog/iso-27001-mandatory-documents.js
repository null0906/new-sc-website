...
export default function ISO27001MandatoryDocuments() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .doc-card .audit-tip{background:rgba(232,99,43,.05);border-left:2px solid var(--cy);padding:.55rem .8rem;border-radius:0 6px 6px 0;font-size:.83rem;color:var(--tb);margin-top:.75rem}
