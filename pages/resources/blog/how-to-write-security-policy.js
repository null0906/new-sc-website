...
export default function SecurityPolicyGuide() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .pc-req{background:rgba(0, 129, 242,.12);color:#0081f2}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 400" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="spg1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#0081f2"/><stop offset="100%" stopColor="#38A8FF"/></linearGradient>
              ...
              <pattern id="sppat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            ...
            <rect x="16" y="50" width="230" height="334" rx="12" fill="#081826" stroke="rgba(0, 129, 242,0.15)" strokeWidth="1"/>
            ...
            <line x1="260" y1="46" x2="260" y2="390" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            <line x1="710" y1="46" x2="710" y2="390" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              <g key={i}>
                <rect x="718" y={82+i*50} width="226" height="38" rx="8" fill="#091826" stroke={sev==='Critical'?"rgba(255,77,109,0.25)":sev==='High'?"rgba(255,183,3,0.2)":"rgba(0, 129, 242,0.15)"} strokeWidth="1"/>
                <text x="734" y={99+i*50} fill="rgba(200,214,229,0.8)" fontSize="8.5" fontFamily="sans-serif">{issue}</text>
                <rect x="734" y={105+i*50} width={sev.length*5.5+10} height="10" rx="3" fill={sev==='Critical'?"rgba(255,77,109,0.15)":sev==='High'?"rgba(255,183,3,0.12)":"rgba(0, 129, 242,0.12)"}/>
                <text x="739" y={113+i*50} fill={sev==='Critical'?"#ff4d6d":sev==='High'?"#ffb703":"#0081f2"} fontSize="7" fontWeight="700" fontFamily="sans-serif">{sev}</text>
              </g>
            ))}
          </svg>
        </div>
