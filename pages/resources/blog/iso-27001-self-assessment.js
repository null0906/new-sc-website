...
export default function ISO27001SelfAssessment() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .sc-2{background:rgba(255, 96, 0,.06);border:1px solid rgba(255, 96, 0,.2)}
    ...
    .sc-2 .sc-time{background:rgba(255, 96, 0,.12);color:var(--cy)}
    ...
    .data-table tr:hover td{background:rgba(255, 96, 0,.03)}
    ...
    .phase-list::before{content:'';position:absolute;left:7px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,#FF6000,rgba(255, 96, 0,.1))}
    ...
    .phase-dur{display:inline-block;background:rgba(255, 96, 0,.1);color:var(--cy);font-size:.68rem;font-weight:700;padding:.1rem .5rem;border-radius:4px;margin-bottom:.3rem}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 380" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <pattern id="apat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern>
            </defs>
            ...
            {[
              ...
              {n:'2', title:'International Markets', detail:'Europe, ME, Japan, Singapore', icon:'🌍', col:'#FF6000', x:340, y:50},
              ...
              {n:'5', title:'DPDP Act Compliance',  detail:'Indian data privacy law',       icon:'🇮🇳', col:'#FF6000', x:340, y:188},
            ...
            {[
              ...
              {range:'4–5 YES', label:'Urgent - start now', col:'#FF6000', x:530},
