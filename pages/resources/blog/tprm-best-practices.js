...
export default function TPRMBestPractices() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .tier-table tr:hover td{background:rgba(232,99,43,.03)}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="vp" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(232,99,43,0.04)"/></pattern>
            </defs>
            ...
            <rect x="16" y="50" width="220" height="354" rx="12" fill="#081826" stroke="rgba(232,99,43,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {type:'Data Processing',       n:18, col:'#E8632B'},
            ...
            <line x1="250" y1="46" x2="250" y2="410" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {name:'Email Security',        cyber:'High',     ops:'Medium', col:'#E8632B'},
              {name:'HRIS System',           cyber:'Medium',   ops:'High',   col:'#E8632B'},
            ...
            <line x1="706" y1="46" x2="706" y2="410" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
