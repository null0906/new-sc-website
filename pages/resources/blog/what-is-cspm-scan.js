...
export default function WhatIsCSPMScan() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .cspm-author-strip{display:flex;align-items:center;gap:1rem;padding:.9rem 1.25rem;background:var(--bgc2);border:1px solid var(--bs);border-radius:10px;max-width:500px;margin-bottom:2.5rem}
    .au-av{width:42px;height:42px;border-radius:50%;background:linear-gradient(135deg,var(--cy),#7b2ff7);display:flex;align-items:center;justify-content:center;font-size:.95rem;font-weight:700;color:#fff;flex-shrink:0}
...
<div className="cspm-hero-wrap">
  ...
  <div className="cspm-author-strip">
    ...
    <div>
      <div className="au-name">Soham Sawant</div>
      <div className="au-meta"><span>✍️ Cybersecurity Expert &amp; Technical Writer</span><span id="read-time">📖 6 min read</span></div>
      <div className="au-meta"><span>📅 March 10, 2026</span><span>🏢 SecComply</span></div>
    </div>
  </div>
