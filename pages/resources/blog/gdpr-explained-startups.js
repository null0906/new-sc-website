...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgf" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          {[
            {n:"EUR 2.92B",sub:"Total GDPR fines issued in 2023",col:"var(--red)",x:50},
            {n:"50,000+",sub:"Data breach notifications per year across EU",col:"var(--accent)",x:270},
            {n:"72 Hours",sub:"Time limit to report a data breach",col:"var(--yellow)",x:500},
            {n:"4%",sub:"Of global turnover - max fine per violation",col:"var(--purple)",x:730},
          ].map(({n,sub,col,x},i) => (
            <g key={i}>
              <rect x={x} y="40" width="200" height="120" rx="14" fill="var(--bg-secondary)" stroke={col+"25"} strokeWidth="1.5"/>
          ...
          <rect x="50" y="185" width="880" height="70" rx="14" fill="#0d1c10" stroke="rgb(var(--red-rgb) / 0.2)" strokeWidth="1.5"/>
          <rect x="50" y="185" width="880" height="3" rx="1.5" fill="var(--red)"/>
