        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <linearGradient id="rg4" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#0081f2"/><stop offset="100%" stopColor="#38A8FF"/></linearGradient>
              <pattern id="rpat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            ...
            {/* VS divider */}
            <circle cx="480" cy="230" r="30" fill="#091826" stroke="rgba(0, 129, 242,0.3)" strokeWidth="1.5"/>
            ...
            {[
              ...
              {label:'Execution',           before:35, after:82, col:'#0081f2'},
