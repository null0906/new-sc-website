...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <rect x="42" y="105" width="155" height="70" rx="6" fill="rgba(232,99,43,0.05)" stroke="rgba(232,99,43,0.15)" strokeWidth="1"/>
          <text x="119" y="125" textAnchor="middle" fill="rgba(200,214,229,0.55)" fontSize="8.5" fontFamily="sans-serif">Watch out for:</text>
          <text x="119" y="145" textAnchor="middle" fill="#E8632B" fontSize="8.5" fontFamily="sans-serif">Dual obligations</text>
          <text x="119" y="162" textAnchor="middle" fill="#E8632B" fontSize="8.5" fontFamily="sans-serif">DPAs with every client</text>
