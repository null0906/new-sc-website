    ...
    <Layout>
      ...
      <style jsx global>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .tools-author-strip{display:flex;align-items:center;gap:20px;flex-wrap:wrap;padding-top:20px;border-top:1px solid var(--bs);font-size:.82rem;color:var(--tm)}
        .tools-author-strip .avatar{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#E8632B,#FF8A50);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:.9rem;color:#fff;flex-shrink:0}
        .tools-author-strip .name{font-weight:700;color:var(--tx);font-size:.9rem}
        .tools-author-strip .sep{opacity:.3}
        .tools-share-row{display:flex;align-items:center;gap:10px;margin-top:4px}
        ...
        .tool-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#E8632B,#FF8A50)}
        .tool-num{position:absolute;top:24px;right:24px;font-size:2.5rem;font-weight:900;color:rgba(232,99,43,.08);line-height:1;font-variant-numeric:tabular-nums}
        ...
        .tool-badge{display:inline-flex;align-items:center;gap:5px;padding:4px 11px;border-radius:100px;font-size:.72rem;font-weight:700;background:rgba(232,99,43,.1);border:1px solid rgba(232,99,43,.2);color:var(--cy)}
        ...
        .check-icon{width:28px;height:28px;border-radius:8px;background:rgba(232,99,43,.1);border:1px solid rgba(232,99,43,.25);display:flex;align-items:center;justify-content:center;font-size:.9rem;flex-shrink:0;margin-top:1px}
