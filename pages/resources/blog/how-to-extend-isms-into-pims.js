...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <rect x="510" y="38" width="420" height="230" rx="14" fill="#180a0d" stroke="rgba(232,99,43,0.3)" strokeWidth="1.5"/>
          <rect x="510" y="38" width="420" height="4" rx="2" fill="#E8632B"/>
          <text x="720" y="65" textAnchor="middle" fill="#E8632B" fontSize="11" fontWeight="800" fontFamily="sans-serif">✗ WHAT ISO 27001 DOES NOT ADDRESS</text>
