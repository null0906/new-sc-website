...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pge" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="440" height="230" rx="14" fill="#071820" stroke="rgb(var(--green-rgb) / 0.25)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="440" height="4" rx="2" fill="var(--green)"/>
          <text x="250" y="65" textAnchor="middle" fill="var(--green)" fontSize="11" fontWeight="800" fontFamily="sans-serif">✓ WHAT ISO 27001 ALREADY COVERS</text>
          ...
          <rect x="50" y="250" width="400" height="8" rx="4" fill="var(--green)" opacity="0.15"/>
          <rect x="50" y="250" width="280" height="8" rx="4" fill="var(--green)" opacity="0.5"/>
          <text x="250" y="270" textAnchor="middle" fill="var(--green)" fontSize="8" fontWeight="700" fontFamily="sans-serif">~50–70% of ISO 27701 work is already done</text>
          <rect x="510" y="38" width="420" height="230" rx="14" fill="#180a0d" stroke="rgb(var(--accent-rgb) / 0.3)" strokeWidth="1.5"/>
          <rect x="510" y="38" width="420" height="4" rx="2" fill="var(--accent)"/>
          <text x="720" y="65" textAnchor="middle" fill="var(--accent)" fontSize="11" fontWeight="800" fontFamily="sans-serif">✗ WHAT ISO 27001 DOES NOT ADDRESS</text>
          ...
          <rect x="530" y="250" width="380" height="8" rx="4" fill="var(--accent)" opacity="0.15"/>
          <rect x="530" y="250" width="130" height="8" rx="4" fill="var(--accent)" opacity="0.5"/>
          <text x="720" y="270" textAnchor="middle" fill="var(--accent)" fontSize="8" fontWeight="700" fontFamily="sans-serif">~30–50% new work required - mostly documentation and process</text>
