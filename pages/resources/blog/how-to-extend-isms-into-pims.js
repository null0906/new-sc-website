...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pge" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          <rect x="510" y="38" width="420" height="230" rx="14" fill="#180a0d" stroke="rgba(255, 96, 0,0.3)" strokeWidth="1.5"/>
          <rect x="510" y="38" width="420" height="4" rx="2" fill="#FF6000"/>
          <text x="720" y="65" textAnchor="middle" fill="#FF6000" fontSize="11" fontWeight="800" fontFamily="sans-serif">✗ WHAT ISO 27001 DOES NOT ADDRESS</text>
          ...
          <rect x="530" y="250" width="380" height="8" rx="4" fill="#FF6000" opacity="0.15"/>
          <rect x="530" y="250" width="130" height="8" rx="4" fill="#FF6000" opacity="0.5"/>
          <text x="720" y="270" textAnchor="middle" fill="#FF6000" fontSize="8" fontWeight="700" fontFamily="sans-serif">~30–50% new work required - mostly documentation and process</text>
