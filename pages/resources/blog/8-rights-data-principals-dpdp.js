...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg2" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          <rect x="148" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#FF600025" strokeWidth="1.5"/>
          <rect x="148" y="35" width="105" height="3" rx="1.5" fill="#FF6000"/>
          <text x="200" y="62" textAnchor="middle" fill="#FF6000" fontSize="18" fontWeight="800" fontFamily="sans-serif">2</text>
          ...
          <rect x="738" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#FF600025" strokeWidth="1.5"/>
          <rect x="738" y="35" width="105" height="3" rx="1.5" fill="#FF6000"/>
          <text x="790" y="62" textAnchor="middle" fill="#FF6000" fontSize="18" fontWeight="800" fontFamily="sans-serif">7</text>
