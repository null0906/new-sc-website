...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <rect x="148" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#E8632B25" strokeWidth="1.5"/>
          <rect x="148" y="35" width="105" height="3" rx="1.5" fill="#E8632B"/>
          <text x="200" y="62" textAnchor="middle" fill="#E8632B" fontSize="18" fontWeight="800" fontFamily="sans-serif">2</text>
          ...
          <rect x="738" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#E8632B25" strokeWidth="1.5"/>
          <rect x="738" y="35" width="105" height="3" rx="1.5" fill="#E8632B"/>
          <text x="790" y="62" textAnchor="middle" fill="#E8632B" fontSize="18" fontWeight="800" fontFamily="sans-serif">7</text>
