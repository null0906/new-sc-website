...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg2" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          <rect x="148" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#0081f225" strokeWidth="1.5"/>
          <rect x="148" y="35" width="105" height="3" rx="1.5" fill="#0081f2"/>
          <text x="200" y="62" textAnchor="middle" fill="#0081f2" fontSize="18" fontWeight="800" fontFamily="sans-serif">2</text>
          ...
          <rect x="266" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#06d6a025" strokeWidth="1.5"/>
          <rect x="266" y="35" width="105" height="3" rx="1.5" fill="#06d6a0"/>
          <text x="318" y="62" textAnchor="middle" fill="#06d6a0" fontSize="18" fontWeight="800" fontFamily="sans-serif">3</text>
          ...
          <rect x="384" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#ffb70325" strokeWidth="1.5"/>
          <rect x="384" y="35" width="105" height="3" rx="1.5" fill="#ffb703"/>
          <text x="436" y="62" textAnchor="middle" fill="#ffb703" fontSize="18" fontWeight="800" fontFamily="sans-serif">4</text>
          ...
          <rect x="502" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#ff4d6d25" strokeWidth="1.5"/>
          <rect x="502" y="35" width="105" height="3" rx="1.5" fill="#ff4d6d"/>
          <text x="554" y="62" textAnchor="middle" fill="#ff4d6d" fontSize="18" fontWeight="800" fontFamily="sans-serif">5</text>
          ...
          <rect x="620" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#818cf825" strokeWidth="1.5"/>
          <rect x="620" y="35" width="105" height="3" rx="1.5" fill="#818cf8"/>
          <text x="672" y="62" textAnchor="middle" fill="#818cf8" fontSize="18" fontWeight="800" fontFamily="sans-serif">6</text>
          ...
          <rect x="738" y="35" width="105" height="80" rx="10" fill="#091826" stroke="#0081f225" strokeWidth="1.5"/>
          <rect x="738" y="35" width="105" height="3" rx="1.5" fill="#0081f2"/>
          <text x="790" y="62" textAnchor="middle" fill="#0081f2" fontSize="18" fontWeight="800" fontFamily="sans-serif">7</text>
          ...
          <rect x="856" y="35" width="100" height="80" rx="10" fill="#091826" stroke="#06d6a025" strokeWidth="1.5"/>
          <rect x="856" y="35" width="100" height="3" rx="1.5" fill="#06d6a0"/>
          <text x="906" y="62" textAnchor="middle" fill="#06d6a0" fontSize="18" fontWeight="800" fontFamily="sans-serif">8</text>
          ...
          <rect x="30" y="145" width="900" height="130" rx="14" fill="#0d1c10" stroke="rgba(255,77,109,0.15)" strokeWidth="1.5"/>
