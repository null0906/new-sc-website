...
export default function AiCodeSecurityRisks() {
  ...
  return (
    <Layout>
      ...
      <style jsx global>{`
        :root{--cy:#E8632B;--cy2:#d0521f;--glow:rgba(232,99,43,.12);--bg:#020617;--bgc:#0B1120;--bgc2:#0F172A;--tx:#F8FAFC;--tb:#E2E8F0;--tm:#94A3B8;--bo:rgba(232,99,43,.2);--bs:rgba(255,255,255,.06);--gr:#10B981;--sans:'Inter',sans-serif;--mono:'JetBrains Mono',monospace}
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .risk-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#E8632B,#FF8A50)}
        .risk-num{position:absolute;top:24px;right:24px;font-size:2.5rem;font-weight:900;color:rgba(232,99,43,.08);line-height:1}
        ...
        .soc2-callout{background:rgba(56,189,248,.05);border:1px solid rgba(56,189,248,.15);border-left:3px solid #38BDF8;border-radius:0 12px 12px 0;padding:18px 22px;margin:2em 0}
        .soc2-callout strong{color:#38BDF8;font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:10px}
        ...
        .check-icon{width:30px;height:30px;border-radius:8px;background:rgba(232,99,43,.1);border:1px solid rgba(232,99,43,.25);display:flex;align-items:center;justify-content:center;font-size:.9rem;flex-shrink:0;margin-top:1px}
