...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .risk-num{position:absolute;top:24px;right:24px;font-size:2.5rem;font-weight:900;color:rgb(var(--accent-rgb) / .08);line-height:1}
        ...
        .soc2-callout{background:rgb(var(--blue-rgb) / .05);border:1px solid rgb(var(--blue-rgb) / .15);border-left:3px solid var(--accent-light);border-radius:0 12px 12px 0;padding:18px 22px;margin:2em 0}
        .soc2-callout strong{color:var(--accent-light);font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;display:block;margin-bottom:10px}
