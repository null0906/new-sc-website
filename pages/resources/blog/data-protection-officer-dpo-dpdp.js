...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg5" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="450" height="220" rx="14" fill="var(--bg-secondary)" stroke="rgba(106,138,170,0.25)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="450" height="3" rx="1.5" fill="var(--text-secondary)"/>
          ...
          <rect x="510" y="38" width="450" height="220" rx="14" fill="#0d1c10" stroke="rgb(var(--accent-rgb) / 0.3)" strokeWidth="1.5"/>
          <rect x="510" y="38" width="450" height="3" rx="1.5" fill="var(--accent)"/>
          <text x="735" y="65" textAnchor="middle" fill="var(--accent)" fontSize="11" fontWeight="700" fontFamily="sans-serif">DATA PROTECTION OFFICER (DPO)</text>
          ...
          <text x="540" y="112" fill="var(--accent)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">• MUST be based in India - non-negotiable</text>
          <text x="540" y="132" fill="var(--accent)" fontSize="9.5" fontWeight="700" fontFamily="sans-serif">• Reports DIRECTLY to Board of Directors</text>
          ...
          <rect x="530" y="210" width="410" height="34" rx="8" fill="rgb(var(--accent-rgb) / 0.08)" stroke="rgb(var(--accent-rgb) / 0.2)" strokeWidth="1"/>
          <text x="735" y="230" textAnchor="middle" fill="var(--accent)" fontSize="10" fontWeight="700" fontFamily="sans-serif">Mandatory only for Significant Data Fiduciaries</text>
        </svg>
        </div>
