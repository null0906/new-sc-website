...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <rect x="510" y="38" width="450" height="220" rx="14" fill="#0d1c10" stroke="rgba(232,99,43,0.3)" strokeWidth="1.5"/>
          ...
          <rect x="530" y="210" width="410" height="34" rx="8" fill="rgba(232,99,43,0.08)" stroke="rgba(232,99,43,0.2)" strokeWidth="1"/>
          <text x="735" y="230" textAnchor="middle" fill="#E8632B" fontSize="10" fontWeight="700" fontFamily="sans-serif">Mandatory only for Significant Data Fiduciaries</text>
        </svg>
        </div>
