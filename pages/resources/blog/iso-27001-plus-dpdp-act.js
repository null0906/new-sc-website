...
export default function ISO27001PlusDPDPAct() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .video-card{display:flex;gap:1.1rem;align-items:center;background:linear-gradient(135deg,rgba(232,99,43,.08),rgba(15,23,42,.6));border:1px solid var(--bo);border-radius:14px;padding:1.3rem 1.5rem;margin:2rem 0;flex-wrap:wrap}
