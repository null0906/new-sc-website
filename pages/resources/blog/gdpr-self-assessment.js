...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgg" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          {[
            ...
            {range:"5–6 YES",label:"High Exposure",desc:"Material gap. Formal assessment needed.",col:"#FF6000",x:520},
          ...
          <rect x="50" y="195" width="880" height="60" rx="14" fill="#0d1c10" stroke="rgba(255, 96, 0,0.15)" strokeWidth="1.5"/>
