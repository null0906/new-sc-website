...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgg" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          {[
            {range:"0–1 YES",label:"Low Scope",desc:"Likely out of scope - verify annually",col:"var(--text-secondary)",x:50},
            {range:"2–4 YES",label:"In Scope",desc:"GDPR applies. Build baseline now.",col:"var(--yellow)",x:280},
            {range:"5–6 YES",label:"High Exposure",desc:"Material gap. Formal assessment needed.",col:"var(--accent)",x:520},
            {range:"7–8 YES",label:"Critical",desc:"Regulatory risk is immediate.",col:"var(--red)",x:750},
          ].map(({range,label,desc,col,x},i) => (
            <g key={i}>
              <rect x={x} y="40" width="195" height="130" rx="14" fill="var(--bg-secondary)" stroke={col+"25"} strokeWidth="1.5"/>
          ...
          <rect x="50" y="195" width="880" height="60" rx="14" fill="#0d1c10" stroke="rgb(var(--accent-rgb) / 0.15)" strokeWidth="1.5"/>
