...
export default function DPDPActExplained() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .ob-num{width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#0081f2,#38A8FF);display:flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:800;color:#fff;flex-shrink:0;margin-top:2px}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="dg1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#0081f2"/><stop offset="100%" stopColor="#38A8FF"/></linearGradient>
              ...
              <pattern id="dpat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            ...
            {/* LEFT: Timeline */}
            <rect x="16" y="50" width="210" height="354" rx="12" fill="#081826" stroke="rgba(0, 129, 242,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {year:'2026',     event:'DPB fully constituted', col:'#0081f2', done:false},
            ...
            <line x1="240" y1="46" x2="240" y2="408" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {violation:'Failure to honour user rights',          penalty:'₹50 Cr',  col:'#0081f2', w:52},
            ...
            <line x1="708" y1="46" x2="708" y2="408" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>

            {/* RIGHT: 5 obligations */}
            <text x="726" y="70" fill="rgba(200,214,229,0.7)" fontSize="10" fontWeight="700" fontFamily="sans-serif">5 CORE OBLIGATIONS</text>
            {[
              {num:'1', ob:'Lawful Basis',        detail:'Consent or legitimate use', col:'#0081f2'},
              {num:'2', ob:'Notice',               detail:'22 Indian languages required', col:'#0081f2'},
