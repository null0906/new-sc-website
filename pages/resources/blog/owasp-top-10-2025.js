...
export default function OWASPTop10() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .owasp-card::before{content:'';position:absolute;top:0;left:0;bottom:0;width:3px;background:var(--c,#E8632B)}
    .owasp-hdr{display:flex;align-items:flex-start;gap:1rem;margin-bottom:.7rem}
    .owasp-num{min-width:44px;height:44px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:800;color:#fff;flex-shrink:0;background:var(--c,#E8632B)}
    ...
    .new-badge{background:rgba(232,99,43,.15);color:#E8632B;font-size:.62rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:.12rem .5rem;border-radius:4px;border:1px solid rgba(232,99,43,.3);margin-left:.5rem;vertical-align:middle}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 440" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="og1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#E8632B"/><stop offset="100%" stopColor="#FF8A50"/></linearGradient>
              ...
              <pattern id="opat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(232,99,43,0.04)"/></pattern>
            </defs>
            ...
            <rect x="16" y="52" width="230" height="372" rx="12" fill="#081826" stroke="rgba(232,99,43,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {rank:'A03', name:'Injection',                 col:'#E8632B', pct:74},
              {rank:'A04', name:'Insecure Design',           col:'#E8632B', pct:64},
            ...
            <line x1="260" y1="48" x2="260" y2="424" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {sev:'High',     count:4, desc:'A03 Injection · A04 Insecure Design · A05 Misconfig · A06 Components', col:'#E8632B', w:200},
            ...
            <rect x="272" y="380" width="420" height="40" rx="10" fill="rgba(232,99,43,0.06)" stroke="rgba(232,99,43,0.2)" strokeWidth="1"/>
            <text x="292" y="397" fill="#E8632B" fontSize="9" fontWeight="700" fontFamily="sans-serif">2025 KEY CHANGE:</text>
            ...
            <line x1="706" y1="48" x2="706" y2="424" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {fw:'OWASP ASVS', controls:'All levels',       col:'#E8632B'},
        ...
        <article className="art">
          ...
          <section id="top-10">
            ...
            <div className="owasp-list">
              ...
              <div className="owasp-card anim" style={{'--c':'#E8632B'}}>
                <div className="owasp-hdr">
                  <div className="owasp-num" style={{background:'#E8632B'}}>A03</div>
              ...
              <div className="owasp-card anim" style={{'--c':'#E8632B'}}>
                <div className="owasp-hdr">
                  <div className="owasp-num" style={{background:'#E8632B'}}>A04</div>
