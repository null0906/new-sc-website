...
export default function SecurityMetricsBoardReporting() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .q-num{width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,#FF6000,#FF8A3D);display:flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:700;color:#fff;flex-shrink:0;margin-top:1px}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 440" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="bdots" width="26" height="26" patternUnits="userSpaceOnUse"><circle cx="13" cy="13" r=".9" fill="rgba(255, 96, 0,0.055)"/></pattern>
            </defs>
            <rect width="960" height="440" fill="url(#bdots)"/>

            {/* ── BOARD SCORECARD: left panel ── */}
            <rect x="22" y="20" width="200" height="130" rx="11" fill="#091d2e" stroke="rgba(255, 96, 0,0.2)" strokeWidth="1"/>
            ...
            <rect x="22" y="164" width="200" height="130" rx="11" fill="#091d2e" stroke="rgba(255, 96, 0,0.2)" strokeWidth="1"/>
            ...
            {/* ── DIVIDER ── */}
            <line x1="238" y1="16" x2="238" y2="424" stroke="rgba(255, 96, 0,0.07)" strokeWidth="1"/>
            ...
            <text x="490" y="195" textAnchor="middle" fill="rgba(255, 96, 0,0.7)" fontSize="9" fontFamily="sans-serif">Board Risk Score</text>
            ...
            <circle cx="368" cy="420" r="3.5" fill="#FF6000"/>
            <circle cx="418" cy="400" r="3.5" fill="#FF6000"/>
            <circle cx="468" cy="390" r="3.5" fill="#FF6000"/>
            <circle cx="518" cy="370" r="3.5" fill="#FF6000"/>
            <circle cx="568" cy="358" r="3.5" fill="#FF6000"/>
            ...
            <text x="556" y="432" fill="rgba(255, 96, 0,0.7)" fontSize="7.5" fontWeight="700" fontFamily="sans-serif">Now</text>

            {/* ── RIGHT PANEL: 5 board questions ── */}
            <line x1="600" y1="16" x2="600" y2="424" stroke="rgba(255, 96, 0,0.07)" strokeWidth="1"/>
