  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel="canonical" href="https://seccomply.net/resources/blog/security-metrics-board-reporting" />        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .q-num{width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,var(--accent),var(--accent-light));display:flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:700;color:#fff;flex-shrink:0;margin-top:1px}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 440" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="bdots" width="26" height="26" patternUnits="userSpaceOnUse"><circle cx="13" cy="13" r=".9" fill="rgb(var(--accent-rgb) / 0.055)"/></pattern>
            </defs>
            <rect width="960" height="440" fill="url(#bdots)"/>

            {/* ── BOARD SCORECARD: left panel ── */}
            <rect x="22" y="20" width="200" height="130" rx="11" fill="#091d2e" stroke="rgb(var(--accent-rgb) / 0.2)" strokeWidth="1"/>
            ...
            <text x="170" y="79" fill="var(--yellow)" fontSize="8" fontWeight="700" fontFamily="sans-serif">70%</text>
            <text x="44" y="99" fill="var(--red)" fontSize="9" fontWeight="600" fontFamily="sans-serif">⚠ 3 systems: unmitigated risk</text>
            ...
            <rect x="22" y="164" width="200" height="130" rx="11" fill="#091d2e" stroke="rgb(var(--accent-rgb) / 0.2)" strokeWidth="1"/>
            ...
            <text x="170" y="223" fill="var(--green)" fontSize="8" fontWeight="700" fontFamily="sans-serif">90%</text>
            <text x="44" y="243" fill="var(--green)" fontSize="9" fontWeight="600" fontFamily="sans-serif">✓ MTTD: 4.2 hrs (down from 11h)</text>
            <text x="44" y="259" fill="var(--green)" fontSize="9" fontWeight="600" fontFamily="sans-serif">✓ MTTR: 6.1 hrs (SLA: 8h)</text>
            <text x="44" y="284" fill="rgba(200,214,229,0.35)" fontSize="7.5" fontFamily="sans-serif">Tested: tabletop exercise Feb 2026</text>

            <rect x="22" y="308" width="200" height="112" rx="11" fill="#0f1c2a" stroke="rgb(var(--red-rgb) / 0.25)" strokeWidth="1"/>
            ...
            <text x="170" y="367" fill="var(--red)" fontSize="8" fontWeight="700" fontFamily="sans-serif">62%</text>
            <circle cx="34" cy="392" r="4" fill="var(--red)"/>
            <text x="44" y="396" fill="var(--red)" fontSize="9" fontWeight="600" fontFamily="sans-serif">CRITICAL: DPDP gap, 2 obligations</text>
            <text x="44" y="412" fill="var(--yellow)" fontSize="9" fontFamily="sans-serif">HIGH: ISO 27001 clause 9.1 pending</text>

            {/* ── DIVIDER ── */}
            <line x1="238" y1="16" x2="238" y2="424" stroke="rgb(var(--accent-rgb) / 0.07)" strokeWidth="1"/>
            ...
            <text x="490" y="195" textAnchor="middle" fill="rgb(var(--accent-rgb) / 0.7)" fontSize="9" fontFamily="sans-serif">Board Risk Score</text>
            <text x="490" y="210" textAnchor="middle" fill="rgba(200,214,229,0.35)" fontSize="8" fontFamily="sans-serif">↑ 6% from last quarter</text>

            {/* Mini stat cards */}
            <rect x="368" y="262" width="94" height="60" rx="9" fill="var(--bg-secondary)" stroke="rgb(var(--green-rgb) / 0.18)" strokeWidth="1"/>
            <text x="415" y="285" textAnchor="middle" fill="var(--green)" fontSize="20" fontWeight="700" fontFamily="sans-serif">4</text>
            <text x="415" y="300" textAnchor="middle" fill="rgba(200,214,229,0.45)" fontSize="8" fontFamily="sans-serif">Categories</text>
            <text x="415" y="314" textAnchor="middle" fill="rgb(var(--green-rgb) / 0.55)" fontSize="7.5" fontFamily="sans-serif">on track ↑</text>

            <rect x="472" y="262" width="94" height="60" rx="9" fill="var(--bg-secondary)" stroke="rgb(var(--red-rgb) / 0.18)" strokeWidth="1"/>
            <text x="519" y="285" textAnchor="middle" fill="var(--red)" fontSize="20" fontWeight="700" fontFamily="sans-serif">2</text>
            <text x="519" y="300" textAnchor="middle" fill="rgba(200,214,229,0.45)" fontSize="8" fontFamily="sans-serif">Require</text>
            <text x="519" y="314" textAnchor="middle" fill="rgb(var(--red-rgb) / 0.55)" fontSize="7.5" fontFamily="sans-serif">board action</text>
            ...
            <circle cx="368" cy="420" r="3.5" fill="var(--accent)"/>
            <circle cx="418" cy="400" r="3.5" fill="var(--accent)"/>
            <circle cx="468" cy="390" r="3.5" fill="var(--accent)"/>
            <circle cx="518" cy="370" r="3.5" fill="var(--accent)"/>
            <circle cx="568" cy="358" r="3.5" fill="var(--accent)"/>
            ...
            <text x="556" y="432" fill="rgb(var(--accent-rgb) / 0.7)" fontSize="7.5" fontWeight="700" fontFamily="sans-serif">Now</text>

            {/* ── RIGHT PANEL: 5 board questions ── */}
            <line x1="600" y1="16" x2="600" y2="424" stroke="rgb(var(--accent-rgb) / 0.07)" strokeWidth="1"/>
            <text x="626" y="46" fill="rgba(200,214,229,0.7)" fontSize="11" fontWeight="700" fontFamily="sans-serif">5 Questions Boards Ask</text>

            {[
              { y: 70,  q: "Would we know about a breach today?",    s: "MTTD: 4.2 hrs",      c: "var(--green)" },
              { y: 148, q: "Could we contain it in time?",            s: "MTTR: 6.1 hrs",      c: "var(--green)" },
              { y: 226, q: "Are our vendors as secure as we are?",    s: "68% independently verified", c: "var(--yellow)" },
              { y: 304, q: "What would a regulator find today?",      s: "2 open gaps",         c: "var(--red)" },
              { y: 348, q: "Keeping pace with business changes?",     s: "New product: assessed", c: "var(--green)" },
            ].map(({ y, q, s, c }, i) => (
              <g key={i}>
                <rect x="618" y={y} width="316" height="64" rx="9" fill="var(--bg-secondary)" stroke={`${c}30`} strokeWidth="1"/>
