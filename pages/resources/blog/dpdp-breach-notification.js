...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .badge-rd{background:rgb(var(--red-rgb) / .1);color:var(--rd);border:1px solid rgb(var(--red-rgb) / .25)}
    ...
    .co-danger{background:rgb(var(--red-rgb) / .07);border:1px solid rgb(var(--red-rgb) / .25)}
