...
export default function CostOfNonCompliance() {
  ...
  return (
    <Layout>
      ...
      <style jsx global>{`
        :root{--cy:#0081f2;--cy2:#d0521f;--bg:#020617;--bgc:#0B1120;--bgc2:#0F172A;--tx:#F8FAFC;--tb:#E2E8F0;--tm:#94A3B8;--bo:rgba(0, 129, 242,.2);--bs:rgba(255,255,255,.06);--rd:#ff4d6d;--gr:#10B981;--am:#ffb703;--sans:'Inter',sans-serif}
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .cost-card::before{content:'';position:absolute;top:0;left:0;bottom:0;width:3px;background:linear-gradient(180deg,#0081f2,#38A8FF)}
        ...
        .case-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#0081f2,#38A8FF)}
