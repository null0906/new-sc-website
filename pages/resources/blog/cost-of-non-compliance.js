...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .cost-card::before{content:'';position:absolute;top:0;left:0;bottom:0;width:3px;background:linear-gradient(180deg,var(--accent),var(--accent-light))}
        ...
        .case-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--accent),var(--accent-light))}
        .case-tag{display:inline-block;padding:3px 10px;border-radius:100px;font-size:.68rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;background:rgb(var(--red-rgb) / .1);border:1px solid rgb(var(--red-rgb) / .25);color:var(--rd);margin-bottom:10px}
          ...
          <section id="compliance-roi">
            ...
            <table className="sc-table">
              ...
              <tbody>
                ...
                ].map(([m, n, c]) => <tr key={m}><td>{m}</td><td style={{color:"var(--rd)"}}>{n}</td><td style={{color:"var(--green-light)"}}>{c}</td></tr>)}
              </tbody>
            </table>
            </div>
          </section>
