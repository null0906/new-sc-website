...
const posts = [
  { slug: 'ciso-startup-guide', icon: '🛡️', tag: 'Security Leadership', title: 'The Role of a CISO in a Startup', desc: "Most startups think they need a CISO when they get hacked. The ones that get it right hire one so they never do. What a Chief Information Security Officer actually does, when to hire one, and the full-time vs vCISO breakdown.", author: 'Soham Sawant', date: 'June 2025', read: '5 min read' },
