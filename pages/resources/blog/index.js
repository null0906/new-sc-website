...
const posts = [
  { slug: 'ciso-startup-guide', icon: '🛡️', tag: 'Security Leadership', title: 'The Role of a CISO in a Startup: Why Your First Security Hire Might Be Your Most Important One', desc: "Most startups think they need a CISO when they get hacked. The ones that get it right hire one so they never do. What a Chief Information Security Officer actually does, when to hire one, and the full-time vs vCISO breakdown.", author: 'Soham Sawant', date: 'June 2025', read: '5 min read' },
  { slug: 'devsecops-shifting-left', icon: '⚙️', tag: 'DevSecOps', title: 'DevSecOps: Shifting Security Left Without Slowing Down', desc: "Security was the team that said no at the end of the pipeline. Here's how DevSecOps changes that — 3 pillars, the complete automation stack (SAST, SCA, DAST, IaC), STRIDE threat modeling, compliance integration, and a 3-phase maturity roadmap.", author: 'Aditya Hadke', date: 'March 2025', read: '12 min read' },
