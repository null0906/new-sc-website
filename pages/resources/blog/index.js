...
const posts = [
  { slug: 'endpoint-security-hybrid-work', icon: '💻', tag: 'Endpoint Security', title: 'Endpoint Security in a Hybrid Work World', desc: "Your office perimeter vanished the day your team went remote. 5 endpoint risks in hybrid environments, what good endpoint security actually looks like in 2026, and how to build continuous compliance across scattered devices.", author: 'Gauri Khatate', date: 'March 2026', read: '5 min read' },
  { slug: 'dpdp-act-compliance-guide-2026', icon: '🇮🇳', tag: 'DPDP Act', title: 'DPDP Act: What Indian Businesses Need to Know', desc: "DPDP Rules notified November 2025. Full enforcement: May 2027. Five core obligations, ₹250 Cr penalty schedule, zero-threshold breach notification, and your readiness roadmap before the deadline.", author: 'Gauri Khatate', date: 'March 2026', read: '5 min read' },
  { slug: 'saas-compliance-checklist', icon: '✅', tag: 'Compliance Checklist', title: 'The Ultimate Compliance Checklist for SaaS Companies', desc: "9 control areas, 50+ actionable items, and a prioritised 7-month roadmap from starting point to SOC 2 or ISO 27001 certification — built for SaaS companies juggling cloud infra, multi-jurisdiction data, and fast release cycles.", author: 'Aditya Hadke', date: 'March 2026', read: '10 min read' },
  { slug: 'how-to-prepare-for-a-security-audit', icon: '🔍', tag: 'Audit Readiness', title: 'How to Prepare for a Security Audit', desc: "The difference between a painful audit and a smooth one isn't luck — it's preparation. 8 stages, the evidence auditors actually look for, and a pre-audit checklist that covers ISO 27001, SOC 2, DPDPA, and GDPR.", author: 'Bhumika Deshmukh', date: 'March 2026', read: '7 min read' },
  { slug: 'security-metrics-board-reporting', icon: '📊', tag: 'Security Governance', title: 'Security Metrics That Actually Matter to the Board', desc: "Most board security reports are full of numbers and short on answers. Six metric categories, five governance questions, and the reporting principles that change what happens in that boardroom.", author: 'Bhumika Deshmukh', date: 'March 2026', read: '8 min read' },
  { slug: 'sbom-software-bill-of-materials', icon: '📦', tag: 'Supply Chain Security', title: 'SBOM 101: Why Software Bills of Materials Matter', desc: 'Log4Shell exposed 625,000+ apps using a library nobody knew they had. An SBOM changes that. The complete guide to Software Bills of Materials — what they are, why regulators require them, SPDX vs CycloneDX, and how to generate one today.', author: 'Soham Sawant', date: 'March 20, 2026', read: '8 min read' },
  { slug: 'vulnerability-management-startups', icon: '🔍', tag: 'Vulnerability Management', title: 'Vulnerability Management for Startups: A Practical Guide to Getting Started', desc: "You don't need a 10-person security team or an enterprise budget. A step-by-step guide: core process, CVSS severity framework, free tools, and a 90-day roadmap to audit-readiness.", author: 'Aditya Hadke', date: 'March 2026', read: '8 min read' },
  { slug: 'cloud-native-security', icon: '☁️', tag: 'Cloud Security', title: 'Cloud-Native Security: Key Concepts Every Team Must Know in 2025', desc: 'From containers to microservices, Zero Trust to DevSecOps — a complete guide to securing modern cloud-native environments and achieving continuous compliance across ISO 27001, SOC 2, HIPAA, and GDPR.', author: 'Soham Sawant', date: 'June 2025', read: '6 min read' },
