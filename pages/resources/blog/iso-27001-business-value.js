...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgs3" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          {[{n:"40%",sub:"Faster enterprise sales cycles",desc:"Replaces lengthy security questionnaires",col:"var(--accent)",x:50},{n:"₹8-25L",sub:"First-year certification cost",desc:"Pays for itself with one enterprise deal",col:"var(--green)",x:280},{n:"25-30%",sub:"Lower cyber insurance premiums",desc:"Certified organisations get better rates",col:"var(--yellow)",x:520},{n:"70,000+",sub:"Organisations certified globally",desc:"The most adopted security standard",col:"var(--purple)",x:750}].map(({n,sub,desc,col,x},i) => (
            <g key={i}>
              <rect x={x} y="38" width="195" height="150" rx="14" fill="var(--bg-secondary)" stroke={col+"25"} strokeWidth="1.5"/>
