...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg3" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="40" y="38" width="170" height="200" rx="14" fill="var(--bg-secondary)" stroke="#818cf825" strokeWidth="1.5"/>
          <rect x="40" y="38" width="170" height="4" rx="2" fill="var(--purple)"/>
          <text x="125" y="78" textAnchor="middle" fill="var(--purple)" fontSize="22" fontWeight="800" fontFamily="sans-serif">FREE</text>
          ...
          <text x="125" y="210" textAnchor="middle" fill="rgb(var(--purple-rgb) / 0.5)" fontSize="8" fontFamily="sans-serif">Pillar 1 of 5</text>
          <rect x="226" y="38" width="170" height="200" rx="14" fill="var(--bg-secondary)" stroke="rgb(var(--accent-rgb) / 0.145)" strokeWidth="1.5"/>
          <rect x="226" y="38" width="170" height="4" rx="2" fill="var(--accent)"/>
          <text x="311" y="78" textAnchor="middle" fill="var(--accent)" fontSize="22" fontWeight="800" fontFamily="sans-serif">SPECIFIC</text>
          ...
          <text x="311" y="210" textAnchor="middle" fill="rgb(var(--accent-rgb) / 0.5)" fontSize="8" fontFamily="sans-serif">Pillar 2 of 5</text>
          <rect x="412" y="38" width="170" height="200" rx="14" fill="var(--bg-secondary)" stroke="#06d6a025" strokeWidth="1.5"/>
          <rect x="412" y="38" width="170" height="4" rx="2" fill="var(--green)"/>
          <text x="497" y="78" textAnchor="middle" fill="var(--green)" fontSize="22" fontWeight="800" fontFamily="sans-serif">INFORMED</text>
          ...
          <text x="497" y="210" textAnchor="middle" fill="rgb(var(--green-rgb) / 0.5)" fontSize="8" fontFamily="sans-serif">Pillar 3 of 5</text>
          <rect x="598" y="38" width="170" height="200" rx="14" fill="var(--bg-secondary)" stroke="#ffb70325" strokeWidth="1.5"/>
          <rect x="598" y="38" width="170" height="4" rx="2" fill="var(--yellow)"/>
          <text x="683" y="78" textAnchor="middle" fill="var(--yellow)" fontSize="22" fontWeight="800" fontFamily="sans-serif">UNCONDITIONAL</text>
          ...
          <text x="683" y="210" textAnchor="middle" fill="rgb(var(--yellow-rgb) / 0.5)" fontSize="8" fontFamily="sans-serif">Pillar 4 of 5</text>
          <rect x="784" y="38" width="148" height="200" rx="14" fill="var(--bg-secondary)" stroke="#ff4d6d25" strokeWidth="1.5"/>
          <rect x="784" y="38" width="148" height="4" rx="2" fill="var(--red)"/>
          <text x="858" y="78" textAnchor="middle" fill="var(--red)" fontSize="20" fontWeight="800" fontFamily="sans-serif">UNAMBIGUOUS</text>
          ...
          <text x="858" y="210" textAnchor="middle" fill="rgb(var(--red-rgb) / 0.5)" fontSize="8" fontFamily="sans-serif">Pillar 5 of 5</text>
