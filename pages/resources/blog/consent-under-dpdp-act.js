...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg3" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          <rect x="226" y="38" width="170" height="200" rx="14" fill="#091826" stroke="#0081f225" strokeWidth="1.5"/>
          <rect x="226" y="38" width="170" height="4" rx="2" fill="#0081f2"/>
          <text x="311" y="78" textAnchor="middle" fill="#0081f2" fontSize="22" fontWeight="800" fontFamily="sans-serif">SPECIFIC</text>
          ...
          <text x="311" y="210" textAnchor="middle" fill="rgba(0, 129, 242,0.5)" fontSize="8" fontFamily="sans-serif">Pillar 2 of 5</text>
