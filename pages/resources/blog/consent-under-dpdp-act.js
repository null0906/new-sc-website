...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pg3" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern></defs>
          ...
          <rect x="226" y="38" width="170" height="200" rx="14" fill="#091826" stroke="#FF600025" strokeWidth="1.5"/>
          <rect x="226" y="38" width="170" height="4" rx="2" fill="#FF6000"/>
          <text x="311" y="78" textAnchor="middle" fill="#FF6000" fontSize="22" fontWeight="800" fontFamily="sans-serif">SPECIFIC</text>
          ...
          <text x="311" y="210" textAnchor="middle" fill="rgba(255, 96, 0,0.5)" fontSize="8" fontFamily="sans-serif">Pillar 2 of 5</text>
