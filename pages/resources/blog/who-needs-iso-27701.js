...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgb" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="440" height="190" rx="14" fill="#091826" stroke="#0081f228" strokeWidth="1.5"/>
          <rect x="30" y="38" width="440" height="4" rx="2" fill="#0081f2"/>
          <text x="250" y="68" textAnchor="middle" fill="#0081f2" fontSize="12" fontWeight="800" fontFamily="sans-serif">PII CONTROLLER (Annex B)</text>
          ...
          <text x="250" y="210" textAnchor="middle" fill="#0081f2" fontSize="9" fontWeight="700" fontFamily="sans-serif">Full accountability - consent, rights, notices, DPIAs</text>
