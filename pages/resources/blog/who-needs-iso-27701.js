...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap">
          ...
          <defs><pattern id="pgb" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgb(var(--accent-rgb) / 0.04)"/></pattern></defs>
          ...
          <rect x="30" y="38" width="440" height="190" rx="14" fill="var(--bg-secondary)" stroke="rgb(var(--accent-rgb) / 0.157)" strokeWidth="1.5"/>
          <rect x="30" y="38" width="440" height="4" rx="2" fill="var(--accent)"/>
          <text x="250" y="68" textAnchor="middle" fill="var(--accent)" fontSize="12" fontWeight="800" fontFamily="sans-serif">PII CONTROLLER (Annex B)</text>
          ...
          <text x="250" y="210" textAnchor="middle" fill="var(--accent)" fontSize="9" fontWeight="700" fontFamily="sans-serif">Full accountability - consent, rights, notices, DPIAs</text>
          <rect x="490" y="38" width="440" height="190" rx="14" fill="#071820" stroke="#06d6a028" strokeWidth="1.5"/>
          <rect x="490" y="38" width="440" height="4" rx="2" fill="var(--green)"/>
          <text x="710" y="68" textAnchor="middle" fill="var(--green)" fontSize="12" fontWeight="800" fontFamily="sans-serif">PII PROCESSOR (Annex C)</text>
          ...
          <text x="710" y="210" textAnchor="middle" fill="var(--green)" fontSize="9" fontWeight="700" fontFamily="sans-serif">Contractual accountability - DPAs, security, breach assist</text>
