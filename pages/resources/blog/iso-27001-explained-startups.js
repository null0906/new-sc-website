...
export default function ISO27001Explained() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .timeline-steps::before{content:'';position:absolute;left:7px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,#0081f2,rgba(0, 129, 242,0.1))}
    ...
    .ts-duration{display:inline-block;background:rgba(0, 129, 242,.1);color:var(--cy);font-size:.7rem;font-weight:700;padding:.1rem .5rem;border-radius:4px;margin-bottom:.3rem}
    ...
    @media(max-width:600px){.cspm-hero-h1{font-size:1.65rem}.toc-grid{grid-template-columns:1fr}.annex-grid{grid-template-columns:1fr}}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 400" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="ig1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#0081f2"/><stop offset="100%" stopColor="#38A8FF"/></linearGradient>
              <linearGradient id="ig2" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#06d6a0"/><stop offset="100%" stopColor="#04b080"/></linearGradient>
              <pattern id="ipat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            ...
            {[
              ...
              <g key={i}>
                <rect x="20" y={64+i*50} width="300" height="38" rx="9" fill="#091826" stroke="rgba(0, 129, 242,0.18)" strokeWidth="1"/>
                <rect x="20" y={64+i*50} width="3" height="38" rx="1.5" fill="#0081f2"/>
                <text x="36" y={80+i*50} fill="#0081f2" fontSize="8" fontWeight="700" fontFamily="sans-serif">{clause}</text>
            ...
            <line x1="338" y1="44" x2="338" y2="388" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              {theme:'Organisational Controls', count:'37', icon:'🏢', col:'#818cf8', desc:'Policies, roles, supplier security, incident mgmt'},
              {theme:'People Controls',         count:'8',  icon:'👥', col:'#06d6a0', desc:'Screening, awareness, training, disciplinary'},
              {theme:'Physical Controls',       count:'14', icon:'🔒', col:'#ffb703', desc:'Physical security, equipment, clear desk'},
              {theme:'Technological Controls',  count:'34', icon:'💻', col:'#0081f2', desc:'Access control, encryption, logging, VAPT'},
            ].map(({theme,count,icon,col,desc},i)=>(
              <g key={i}>
                <rect x="356" y={64+i*74} width="360" height="60" rx="11" fill="#091826" stroke={`${col}25`} strokeWidth="1"/>
            ...
            <line x1="730" y1="44" x2="730" y2="388" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              {label:'Timeline to cert',       val:'4–9 mo',     col:'#0081f2'},
              {label:'Typical cost (India)',    val:'₹8–25L',     col:'#ffb703'},
              {label:'Annex A controls',        val:'93',         col:'#818cf8'},
              {label:'Cert validity',           val:'3 years',    col:'#06d6a0'},
              {label:'Surveillance audits',     val:'Annual',     col:'#0081f2'},
              {label:'Countries recognising',   val:'100+',       col:'#06d6a0'},
            ].map(({label,val,col},i)=>(
              <g key={i}>
                <rect x="742" y={64+i*52} width="202" height="40" rx="9" fill="#091826" stroke={`${col}20`} strokeWidth="1"/>
      ...
      <div className="blog-layout">
        <article className="art">
          ...
          <p style={{fontSize:'1.05rem',lineHeight:'1.85',color:'var(--tb)',marginBottom:'1.5rem',borderLeft:'3px solid rgba(0, 129, 242,0.3)',paddingLeft:'1.2rem'}}>Most startup founders encounter ISO 27001 for the first time in a security questionnaire from a potential enterprise customer. The question is usually short ,"Does your organisation hold ISO 27001 certification?" ,but the answer has real commercial consequences. Deals stall. Procurement teams ask for it. Investors flag it during due diligence. This guide cuts through the jargon and tells you exactly what ISO 27001 is, what getting certified actually involves, and how to make the decision about whether your startup needs it now or later.</p>
