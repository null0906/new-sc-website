...
export default function ISO27001Explained() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .timeline-steps::before{content:'';position:absolute;left:7px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,#E8632B,rgba(232,99,43,0.1))}
    ...
    .ts-duration{display:inline-block;background:rgba(232,99,43,.1);color:var(--cy);font-size:.7rem;font-weight:700;padding:.1rem .5rem;border-radius:4px;margin-bottom:.3rem}
    ...
    @media(max-width:600px){.cspm-hero-h1{font-size:1.65rem}.toc-grid{grid-template-columns:1fr}.annex-grid{grid-template-columns:1fr}}
      ...
      <div className="cspm-hero-wrap">
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 400" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              <linearGradient id="ig1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#E8632B"/><stop offset="100%" stopColor="#FF8A50"/></linearGradient>
              ...
              <pattern id="ipat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(232,99,43,0.04)"/></pattern>
            </defs>
            ...
            {[
              ...
              <g key={i}>
                <rect x="20" y={64+i*50} width="300" height="38" rx="9" fill="#091826" stroke="rgba(232,99,43,0.18)" strokeWidth="1"/>
                <rect x="20" y={64+i*50} width="3" height="38" rx="1.5" fill="#E8632B"/>
                <text x="36" y={80+i*50} fill="#E8632B" fontSize="8" fontWeight="700" fontFamily="sans-serif">{clause}</text>
            ...
            <line x1="338" y1="44" x2="338" y2="388" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {theme:'Technological Controls',  count:'34', icon:'💻', col:'#E8632B', desc:'Access control, encryption, logging, VAPT'},
            ...
            <line x1="730" y1="44" x2="730" y2="388" stroke="rgba(232,99,43,0.07)" strokeWidth="1"/>
            ...
            {[
              {label:'Timeline to cert',       val:'4–9 mo',     col:'#E8632B'},
              ...
              {label:'Surveillance audits',     val:'Annual',     col:'#E8632B'},
      ...
      <div className="blog-layout">
        <article className="art">
          ...
          <p style={{fontSize:'1.05rem',lineHeight:'1.85',color:'var(--tb)',marginBottom:'1.5rem',borderLeft:'3px solid rgba(232,99,43,0.3)',paddingLeft:'1.2rem'}}>Most startup founders encounter ISO 27001 for the first time in a security questionnaire from a potential enterprise customer. The question is usually short ,"Does your organisation hold ISO 27001 certification?" ,but the answer has real commercial consequences. Deals stall. Procurement teams ask for it. Investors flag it during due diligence. This guide cuts through the jargon and tells you exactly what ISO 27001 is, what getting certified actually involves, and how to make the decision about whether your startup needs it now or later.</p>
