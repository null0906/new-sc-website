    ...
    <Layout>
      ...
      <style jsx global>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .soc-hero-wrap::before{content:'';position:absolute;top:-120px;right:-80px;width:500px;height:500px;background:radial-gradient(circle,rgba(0, 129, 242,.08) 0%,transparent 70%);pointer-events:none}
        ...
        .soc-cat-badge{display:inline-flex;align-items:center;gap:7px;padding:5px 14px;background:rgba(0, 129, 242,.1);border:1px solid rgba(0, 129, 242,.25);border-radius:100px;font-size:.72rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--cy);margin-bottom:20px}
        ...
        .soc-hero-h1 .acc{background:linear-gradient(90deg,#0081f2,#38A8FF);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
        ...
        .soc-author-strip .avatar{width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,#0081f2,#38A8FF);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:.95rem;color:#fff;flex-shrink:0;box-shadow:0 4px 16px rgba(0, 129, 242,.3)}
        ...
        .art a{color:var(--cy);text-decoration:underline;text-decoration-color:rgba(0, 129, 242,.35)}
        ...
        .comp-table th:nth-child(2){background:rgba(0, 129, 242,.06);color:var(--cy)}
        ...
        .comp-table td:nth-child(2){background:rgba(0, 129, 242,.02)}
        ...
        .scenario-table th{background:rgba(0, 129, 242,.08);color:var(--cy);font-weight:700;padding:10px 16px;text-align:left;font-size:.78rem;text-transform:uppercase;letter-spacing:.06em;border-bottom:2px solid rgba(0, 129, 242,.2)}
      ...
      <div className="art-wrap">
        <article className="art">
          ...
          <section id="what-is-iso27001">
            ...
            <div className="key-takeaway" style={{background:"rgba(0, 129, 242,.05)",border:"1px solid rgba(0, 129, 242,.18)"}}>
