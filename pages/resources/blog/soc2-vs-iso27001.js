...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* Hero */
        .soc-hero-wrap{background:linear-gradient(160deg,var(--bg-primary) 0%,var(--bg-secondary) 60%,var(--bg-card) 100%);border-bottom:1px solid var(--bs);padding:96px 0 60px;position:relative;overflow:hidden}
        .soc-hero-wrap::before{content:'';position:absolute;top:-120px;right:-80px;width:500px;height:500px;background:radial-gradient(circle,rgb(var(--accent-rgb) / .08) 0%,transparent 70%);pointer-events:none}
        ...
        .soc-cat-badge{display:inline-flex;align-items:center;gap:7px;padding:5px 14px;background:rgb(var(--accent-rgb) / .1);border:1px solid rgb(var(--accent-rgb) / .25);border-radius:100px;font-size:.72rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--cy);margin-bottom:20px}
        ...
        .soc-hero-h1 .acc{background:linear-gradient(90deg,var(--accent),var(--accent-light));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
        ...
        .soc-author-strip .avatar{width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,var(--accent),var(--accent-light));display:flex;align-items:center;justify-content:center;font-weight:800;font-size:.95rem;color:#fff;flex-shrink:0;box-shadow:0 4px 16px rgb(var(--accent-rgb) / .3)}
        ...
        .art a{color:var(--cy);text-decoration:underline;text-decoration-color:rgb(var(--accent-rgb) / .35)}
        ...
        .comp-table th:nth-child(2){background:rgb(var(--accent-rgb) / .06);color:var(--cy)}
        .comp-table th:nth-child(3){background:rgb(var(--green-rgb) / .06);color:var(--green-light)}
        ...
        .comp-table td:nth-child(2){background:rgb(var(--accent-rgb) / .02)}
        .comp-table td:nth-child(3){background:rgb(var(--green-rgb) / .02)}
        ...
        .decision-card.iso h3{color:var(--green-light)}
        ...
        .decision-card.iso li::before{color:var(--green-light)}

        /* Scenario table */
        .scenario-table{width:100%;border-collapse:collapse;margin:1.5em 0;font-size:.88rem}
        .scenario-table th{background:rgb(var(--accent-rgb) / .08);color:var(--cy);font-weight:700;padding:10px 16px;text-align:left;font-size:.78rem;text-transform:uppercase;letter-spacing:.06em;border-bottom:2px solid rgb(var(--accent-rgb) / .2)}
        ...
        .misconception::before{content:'✗';position:absolute;left:16px;top:18px;color:var(--red);font-size:1.2rem;font-weight:900}
        .misconception .myth{font-size:.92rem;font-weight:700;color:var(--red);margin-bottom:6px}
      ...
      <div className="art-wrap">
        <article className="art">
          ...
          <section id="what-is-iso27001">
            ...
            <div className="key-takeaway" style={{background:"rgb(var(--accent-rgb) / .05)",border:"1px solid rgb(var(--accent-rgb) / .18)"}}>
