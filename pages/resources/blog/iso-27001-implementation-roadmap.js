...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .roadmap-step .step-deliv{background:rgb(var(--green-rgb) / 0.04);border-left:2px solid var(--gr);padding:.65rem .85rem;border-radius:0 6px 6px 0;font-size:.85rem;color:var(--tb);margin-top:.65rem;line-height:1.6}
