...
export default function GDPRvsDPDP() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .compare-table th:nth-child(3){color:#FF6000}
    ...
    .compare-table tr:hover td{background:rgba(255, 96, 0,.03)}
    ...
    .tick-u{color:#ffb703;font-weight:600}
    ...
    .pri-high{background:rgba(255, 96, 0,.12);color:#FF6000}
    ...
    .right-dpdp{background:rgba(255, 96, 0,.06);border:1px solid rgba(255, 96, 0,.2)}
    ...
    .right-dpdp .rc-label{color:#FF6000}
    ...
    @media(max-width:600px){.cspm-hero-h1{font-size:1.65rem}.toc-grid{grid-template-columns:1fr}.rights-grid{grid-template-columns:1fr}}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 400" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <linearGradient id="gg2" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#FF6000"/><stop offset="100%" stopColor="#FF8A3D"/></linearGradient>
              ...
              <pattern id="gpat" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(255, 96, 0,0.04)"/></pattern>
            </defs>
            ...
            <text x="236" y="70" textAnchor="middle" fill="#818cf8" fontSize="13" fontWeight="700" fontFamily="sans-serif">🇪🇺  GDPR</text>
            ...
            {/* DPDP header */}
            <rect x="504" y="46" width="440" height="340" rx="12" fill="#081826" stroke="rgba(255, 96, 0,0.2)" strokeWidth="1.5"/>
            <rect x="504" y="46" width="440" height="4" rx="2" fill="url(#gg2)"/>
            <text x="724" y="70" textAnchor="middle" fill="#FF6000" fontSize="13" fontWeight="700" fontFamily="sans-serif">🇮🇳  DPDP Act 2023</text>
            ...
            <rect x="512" y="370" width="424" height="12" rx="4" fill="rgba(255, 96, 0,0.08)" stroke="rgba(255, 96, 0,0.2)" strokeWidth="1"/>
            <text x="724" y="380" textAnchor="middle" fill="#FF6000" fontSize="8" fontWeight="700" fontFamily="sans-serif">22 languages · Nomination right · Consent Manager · Age 18</text>
          </svg>
        </div>
      ...
      <div className="blog-layout">
        <article className="art">
          ...
          <div style={{marginTop:'2.5rem',padding:'1.8rem 2rem',background:'rgba(255, 96, 0,0.04)',border:'1px solid rgba(255, 96, 0,0.12)',borderRadius:'14px'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'0.8rem'}}>
              {[
                ...
                <a key={i} href={href} target="_blank" rel="noopener" style={{display:'flex',gap:'0.8rem',padding:'0.9rem 1.1rem',background:'var(--bgc2)',border:'1px solid var(--bs)',borderRadius:'10px',textDecoration:'none',transition:'border-color .2s',alignItems:'flex-start'}}
                  onMouseEnter={e=>e.currentTarget.style.borderColor='rgba(255, 96, 0,0.3)'}
