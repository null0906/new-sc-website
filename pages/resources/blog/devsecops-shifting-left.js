...
export default function DevSecOpsShiftingLeft() {
  ...
  return (
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .pipe-badge-build{background:rgba(0, 129, 242,.15);color:#0081f2}
    ...
    .phase-card:nth-child(2){border-color:#0081f2}
        ...
        <div className="img-wrap">
          <svg viewBox="0 0 960 440" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
            <defs>
              ...
              <pattern id="dpat" width="24" height="24" patternUnits="userSpaceOnUse"><circle cx="12" cy="12" r=".8" fill="rgba(0, 129, 242,0.04)"/></pattern>
            </defs>
            ...
            {[
              ...
              {stage:'Code',     sec:'SAST · Secrets',col:'#0081f2', x:165},
              {stage:'Build',    sec:'SCA · Container',col:'#0081f2',x:290},
            ...
            {/* Shift left arrow */}
            <path d="M900 115 L50 115" stroke="rgba(0, 129, 242,0.3)" strokeWidth="1.5" strokeDasharray="5,4"/>
            <text x="480" y="110" textAnchor="middle" fill="rgba(0, 129, 242,0.5)" fontSize="8.5" fontWeight="700" fontFamily="sans-serif">← SHIFT LEFT, catch issues earlier, fix them cheaper</text>

            <line x1="20" y1="128" x2="940" y2="128" stroke="rgba(255,255,255,0.05)" strokeWidth="1"/>

            {/* LEFT, 3 Pillars */}
            <rect x="18" y="138" width="195" height="284" rx="12" fill="#081826" stroke="rgba(0, 129, 242,0.15)" strokeWidth="1"/>
            ...
            {[
              ...
              {pillar:'Automation',  desc:'SAST · SCA · Container scan · IaC · DAST · CSPM at every stage', col:'#0081f2', icon:'⚙️'},
            ...
            <line x1="228" y1="130" x2="228" y2="430" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {label:'Pipelines with Security Gates',     val:'87%', sub:'↑ from 42%',  col:'#0081f2', bar:130},
            ...
            <line x1="862" y1="130" x2="862" y2="430" stroke="rgba(0, 129, 242,0.07)" strokeWidth="1"/>
            ...
            {[
              ...
              {phase:'Phase 2',  title:'Integrated',    time:'3–6 mo',  col:'#0081f2', done:false},
            ...
            {[
              ...
              {stage:'Release', cost:'15×', w:120, col:'#0081f2', x:484},
            ...
            <div className="img-wrap" style={{marginTop:'1.5rem'}}>
              <svg viewBox="0 0 760 200" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'#081826'}}>
                ...
                {[
                  ...
                  {letter:'T', name:'Tampering',           desc:'Modifying data or code without auth',        col:'#0081f2', x:168},
                  ...
                  {letter:'E', name:'Elevation of Priv.',  desc:'Gaining privileges above entitlement',      col:'#0081f2', x:700},
