...
`}</style>
      ...
      <div className="hero-wrap">
        ...
        <div className="img-wrap"><svg viewBox="0 0 960 260" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',display:'block',background:'linear-gradient(160deg,#071728 0%,#040f1b 100%)'}}>
          <defs><pattern id="pgsc" width="22" height="22" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r=".7" fill="rgba(0, 129, 242,0.04)"/></pattern></defs>
          ...
          <rect x="340" y="40" width="280" height="180" rx="14" fill="#0d1c10" stroke="rgba(6,214,160,0.3)" strokeWidth="1.5"/>
          <rect x="340" y="40" width="280" height="4" rx="2" fill="#06d6a0"/>
          <text x="480" y="75" textAnchor="middle" fill="#06d6a0" fontSize="14" fontWeight="800" fontFamily="sans-serif">JUST RIGHT</text>
          ...
          <rect x="650" y="40" width="280" height="180" rx="14" fill="#141108" stroke="rgba(255,183,3,0.25)" strokeWidth="1.5"/>
          <rect x="650" y="40" width="280" height="4" rx="2" fill="#ffb703"/>
          <text x="790" y="75" textAnchor="middle" fill="#ffb703" fontSize="14" fontWeight="800" fontFamily="sans-serif">TOO NARROW</text>
