    ...
    <Layout>
      ...
      <style jsx global>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .compliance-note{background:rgba(255, 96, 0,.05);border:1px solid rgba(255, 96, 0,.18);border-left:3px solid var(--cy);border-radius:0 12px 12px 0;padding:18px 22px;margin:2em 0}
        ...
        .risk-num{position:absolute;top:22px;right:24px;font-size:2.5rem;font-weight:900;color:rgba(255, 96, 0,.08);line-height:1}
