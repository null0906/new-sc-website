    ...
    <Layout>
      ...
      <style jsx global>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .compliance-note{background:rgba(232,99,43,.05);border:1px solid rgba(232,99,43,.18);border-left:3px solid var(--cy);border-radius:0 12px 12px 0;padding:18px 22px;margin:2em 0}
        ...
        .risk-num{position:absolute;top:22px;right:24px;font-size:2.5rem;font-weight:900;color:rgba(232,99,43,.08);line-height:1}
