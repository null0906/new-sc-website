  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .cp-callout{background:linear-gradient(135deg,rgb(var(--accent-rgb) / .08),rgb(var(--accent-rgb) / .03));border:1px solid rgb(var(--accent-rgb) / .25);border-left:4px solid var(--cy);border-radius:14px;padding:1.4rem 1.6rem;margin:0 0 3rem}
        ...
        .cp-callout-body a{color:var(--cy);text-decoration:none;font-weight:600;border-bottom:1px solid rgb(var(--accent-rgb) / .3)}
        ...
        .cp-p a{color:var(--cy);text-decoration:none;font-weight:600;border-bottom:1px solid rgb(var(--accent-rgb) / .3);transition:border-color .15s}
        ...
        .cp-cat-banner{padding:1rem 1.4rem;border-bottom:1px solid var(--bs);background:rgb(var(--accent-rgb) / .06)}
        ...
        .cp-list li a{color:var(--cy);text-decoration:none;font-weight:600;border-bottom:1px solid rgb(var(--accent-rgb) / .3)}
