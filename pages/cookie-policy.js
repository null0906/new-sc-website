...
export default function CookiePolicy() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        :root{--cy:#FF6000;--cy2:#d0521f;--bg:#020617;--bgc:#0B1120;--bgc2:#0F172A;--tx:#fff;--tb:#c8d6e5;--tm:#6a8aaa;--bo:rgba(255, 96, 0,.2);--bs:rgba(255,255,255,.06);--gr:#06d6a0;--am:#ffb703;--sans:'Inter',-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif}
        ...
        .cp-callout{background:linear-gradient(135deg,rgba(255, 96, 0,.08),rgba(255, 96, 0,.03));border:1px solid rgba(255, 96, 0,.25);border-left:4px solid var(--cy);border-radius:14px;padding:1.4rem 1.6rem;margin:0 0 3rem}
        ...
        .cp-callout-body a{color:var(--cy);text-decoration:none;font-weight:600;border-bottom:1px solid rgba(255, 96, 0,.3)}
        ...
        .cp-p a{color:var(--cy);text-decoration:none;font-weight:600;border-bottom:1px solid rgba(255, 96, 0,.3);transition:border-color .15s}
        ...
        .cp-cat-banner{padding:1rem 1.4rem;border-bottom:1px solid var(--bs);background:rgba(255, 96, 0,.06)}
        ...
        .cp-list li a{color:var(--cy);text-decoration:none;font-weight:600;border-bottom:1px solid rgba(255, 96, 0,.3)}
