...
.step-card:hover .step-number{text-shadow:0 0 30px rgba(232,99,43,0.6),0 0 60px rgba(232,99,43,0.3)}
      ...
      <style dangerouslySetInnerHTML={{__html: `.nav-dropdown{position:relative;list-style:none}.nav-dropdown-trigger{display:inline-flex;align-items:center;gap:4px;font-size:14px;font-weight:500;color:#FFFFFF;cursor:pointer;transition:var(--transition)}.nav-dropdown-trigger:hover{color:var(--white)}.nav-dropdown:hover .dropdown-arrow{transform:rotate(180deg)}.nav-dropdown-menu{position:absolute;top:calc(100% + 8px);left:50%;transform:translateX(-50%) translateY(8px);background:var(--bg-card);border:1px solid rgba(255,255,255,.08);border-radius:var(--radius-lg);padding:10px;min-width:720px;opacity:0;visibility:hidden;transition:all .25s ease;box-shadow:0 25px 60px rgba(0,0,0,.6);z-index:100;display:grid;grid-template-columns:repeat(4,1fr);gap:4px}.nav-dropdown:hover .nav-dropdown-menu{opacity:1;visibility:visible;transform:translateX(-50%) translateY(0)}.nav-dropdown-menu a{display:flex;align-items:center;gap:10px;padding:9px 14px;border-radius:var(--radius-sm);font-size:13px;color:var(--blue-400);transition:all .15s;white-space:nowrap}.nav-dropdown-menu a:hover{background:rgba(232,99,43,.08);color:var(--white)}.nav-dropdown-menu a::after{display:none}button.faq-question{background:var(--bg-card,#111B2E);color:var(--white,#fff);border:1px solid rgba(255,255,255,.08);border-radius:var(--radius-md,12px);padding:20px 24px;width:100%;text-align:left;font-size:16px;font-weight:500;cursor:pointer;display:flex;justify-content:space-between;align-items:center;transition:all .3s ease;font-family:inherit}button.faq-question:hover{background:var(--bg-card-hover,#162036);border-color:rgba(255,255,255,.12)}.tm-mark{font-size:14px !important;color:#94A3B8 !important;font-weight:500 !important;vertical-align:super !important;margin-left:2px !important;display:inline !important;line-height:1 !important}.res-dd{position:relative;list-style:none}.res-dd-trigger{display:inline-flex;align-items:center;gap:4px;font-size:14px;font-weight:500;color:#FFFFFF;cursor:pointer}.res-dd:hover .res-dd-arrow{transform:rotate(180deg)}.res-dd-menu{position:absolute;top:calc(100% + 8px);left:50%;transform:translateX(-50%) translateY(8px);background:var(--bg-card);border:1px solid rgba(255,255,255,.08);border-radius:var(--radius-lg);padding:10px;min-width:380px;opacity:0;visibility:hidden;transition:all .25s ease;box-shadow:0 25px 60px rgba(0,0,0,.6);z-index:100;display:grid;grid-template-columns:repeat(2,1fr);gap:4px}.res-dd:hover .res-dd-menu{opacity:1;visibility:visible;transform:translateX(-50%) translateY(0)}.res-dd-menu a{display:flex;align-items:center;gap:10px;padding:9px 14px;border-radius:var(--radius-sm);font-size:13px;color:var(--blue-400);transition:all .15s;white-space:nowrap}.res-dd-menu a:hover{background:rgba(232,99,43,.08);color:var(--white)}.res-dd-menu a::after{display:none}.footer-socials-box{display:flex;gap:10px;margin-top:16px;flex-wrap:wrap}.fsoc{display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:50%;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.08);color:#94A3B8;transition:all .2s;text-decoration:none}.fsoc:hover{background:rgba(232,99,43,.15);border-color:rgba(232,99,43,.35);color:#E8632B}.fsoc svg{width:15px;height:15px;fill:currentColor}html,body{margin:0;padding:0}#__next{display:flex;flex-direction:column;min-height:100vh}.footer{margin-top:auto;flex-shrink:0}`}} />
