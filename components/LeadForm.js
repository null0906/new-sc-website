...
const lfStyles = `
  ...
  .lf-field em { color:var(--accent,#FF6000); font-style:normal; }
  ...
  .lf-field input:focus, .lf-field select:focus { border-color:var(--accent,#FF6000); }
  .lf-multi { gap:.5rem; }
  ...
  .lf-multi-opt:hover { border-color:var(--accent,#FF6000); }
  .lf-multi-opt.checked { border-color:var(--accent,#FF6000); background:rgba(255, 96, 0,.08); color:var(--white,#F8FAFC); }
  .lf-multi-opt input { width:16px; height:16px; accent-color:var(--accent,#FF6000); flex-shrink:0; cursor:pointer; }
  ...
  .lf-check input { margin-top:2px; width:16px; height:16px; accent-color:var(--accent,#FF6000); flex-shrink:0; }
  .lf-check em { color:var(--accent,#FF6000); font-style:normal; }
  .lf-error { color:var(--red,#EF4444); font-size:.85rem; margin:0; }
  .lf-submit {
    background:var(--gradient-accent,linear-gradient(135deg,#FF6000,#FF8A3D));
  ...
  .lf-submit:hover:not(:disabled){ transform:translateY(-1px); box-shadow:0 8px 24px rgba(255, 96, 0,.3); }
  ...
  .lf-fineprint a { color:var(--accent,#FF6000); }
