      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            .nav-dropdown-menu .mega-inner{width:min(1320px,calc(100% - 28px));margin:0 auto;display:grid;grid-template-columns:minmax(0,1fr) 1px minmax(0,1fr);gap:0;box-sizing:border-box}
